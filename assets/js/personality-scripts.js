! function(e) {
    ...
    function I() { "object" === H(window.SUI) && setTimeout(function() { SUI.suiAccordion(jQuery(".sui-accordion")), SUI.suiTabs(jQuery(".sui-tabs")), jQuery(".sui-2-6-0 select").not(".sui-select").not(".powerform-select").not(".powerform-time").not(".fui-multi-select").each(function() { SUI.suiSelect(jQuery(this)) }), jQuery(".sui-2-6-0 select.sui-select").not(".fui-multi-select").not(".custom-select2").each(function() { jQuery(this).SUIselect2({ dropdownCssClass: "sui-select-dropdown" }) }), SUI.loadCircleScore(jQuery(".sui-circle-score")), SUI.showHidePassword() }, 50) }
            ...
            return o(t, e), s(t, [{ key: "updateValue", value: function(e) { "function" == typeof this.props.updateProperty ? this.props.updateProperty(this.props.property, e) : this.props.actions.settingsActions.updateSetting(this.props.property, e) } }, { key: "isValid", value: function(e) { return this.props.isRequired ? this.props.isRequired && !_.isEmpty(e) : !!_.isUndefined(this.props.isPositive) || (_.isEmpty(e) || e >= 0) } }, {
                ...
                value: function() {
                    ...
                    var p = u.default.createElement("input", i({ type: n, placeholder: this.props.placeholder, value: t || "", id: "powerform-field-" + l, className: s }, this.props.notWritable && { readonly: "" }, this.props.minValue && { min: this.props.minValue }, this.props.maxValue && { max: this.props.maxValue }, this.props.maxLength && { maxlength: this.props.maxLength }, this.props.inputStyles && { style: this.props.inputStyles }, { disabled: !!this.props.disabled, onChange: function(t) { e.updateValue(t.target.value) } })),
                        d = u.default.createElement("div", { className: o + " " + a }, f, this.props.canTrash ? u.default.createElement("div", { className: "sui-with-button sui-with-button-icon" }, p, u.default.createElement("button", { className: "sui-button-icon sui-tooltip sui-tooltip-top-right", "data-tooltip": (0, c.translate)("Löschen") }, u.default.createElement("i", { className: "sui-icon-trash", "aria-hidden": "true" }))) : p, this.props.suffix && u.default.createElement("span", { className: "sui-field-suffix" }, this.props.suffix), this.props.isRequired && !this.isValid(t) && u.default.createElement("span", { className: "sui-error-message" }, r), !_.isUndefined(this.props.isPositive) && !this.isValid(t) && u.default.createElement("span", { className: "sui-error-message" }, (0, c.translate)("Bitte gib eine gültige Nummer ein.")), this.props.description && u.default.createElement("span", { className: "sui-description" }, this.props.description));
        ...
        c = function(e) {
            ...
            return o(t, e), i(t, [{
                ...
                value: function() {
                    ...
                    return l.default.createElement(l.default.Fragment, null, n && l.default.createElement(l.default.Fragment, null, l.default.createElement("li", { className: "psource-dropdown--option" }, l.default.createElement("strong", null, (0, u.translate)("Benötigte Felder"))), l.default.createElement(l.default.Fragment, null, n)), !_.isUndefined(a[0]) && a && l.default.createElement(l.default.Fragment, null, l.default.createElement("li", { className: "psource-dropdown--option" }, l.default.createElement("strong", null, (0, u.translate)("Optionale Felder"))), l.default.createElement(l.default.Fragment, null, a)))
                }
            }, {
                key: "getMiscData",
                value: function() {
                    ...
                    return l.default.createElement(l.default.Fragment, null, l.default.createElement("li", { className: "psource-dropdown--option" }, l.default.createElement("strong", null, (0, u.translate)("Verschiedene Daten"))), _.map(t, function(t, n) { return l.default.createElement("li", { className: "psource-dropdown--option", key: n }, l.default.createElement("a", { className: "psource-insert-content", onClick: e.insertContent.bind(e, n) }, t)) }))
                }
            }, {
                key: "getPaymentData",
                value: function() {
                    ...
                    if (!_.isEmpty(t) || !_.isEmpty(n)) return l.default.createElement(l.default.Fragment, null, this.props.paymentOptions && l.default.createElement("li", { className: "psource-dropdown--option" }, l.default.createElement("strong", null, (0, u.translate)("Zahlungsdaten"))), _.map(r, function(t, n) { return l.default.createElement("li", { className: "psource-dropdown--option", key: n }, l.default.createElement("a", { className: "psource-insert-content", onClick: e.insertContent.bind(e, n) }, t)) }))
                }
            }, {
                ...
                value: function() {
                    ...
                    var t = this.props.disableMiscData ? "" : this.getMiscData(),
                        ...
                        a = this.props.mainOptions ? this.props.mainOptions : { form_name: (0, u.translate)("Formularname") };
                    return l.default.createElement("ul", { className: this.state.editorOptionsOpen ? "sui-active" : "" }, this.props.enableAllFormFields && l.default.createElement("li", { className: "psource-dropdown--option" }, l.default.createElement("a", { className: "psource-insert-content", onClick: this.insertContent.bind(this, "all_fields") }, (0, u.translate)("Alle Formularfelder"))), this.props.enableAllNonFormFields && l.default.createElement("li", { className: "psource-dropdown--option" }, l.default.createElement("a", { className: "psource-insert-content", onClick: this.insertContent.bind(this, "all_non_empty_fields") }, (0, u.translate)("Alle nicht leeren Felder"))), r, l.default.createElement(l.default.Fragment, null, this.props.mainOptionsLabel && l.default.createElement("li", { className: "psource-dropdown--option" }, l.default.createElement("strong", null, this.props.mainOptionsLabel)), _.map(a, function(t, n) { return l.default.createElement("li", { className: "psource-dropdown--option", key: n }, l.default.createElement("a", { className: "psource-insert-content", onClick: e.insertContent.bind(e, n) }, t)) })), t, n)
                }
                ...
                value: function() {
                    var e = this,
                        ...
                        r = _.isUndefined(this.props.requiredError) ? (0, u.translate)("Dieses Feld wird benötigt!") : this.props.requiredError,
                        a = this.isValid(t) ? "" : "sui-form-field-error",
                        o = void 0;
                    _.isEmpty(n) || (o = l.default.createElement("div", { className: "sui-editor-options" }, l.default.createElement("button", { className: this.state.editorOptionsOpen ? "sui-tooltip sui-active" : "sui-tooltip", "data-tooltip": (0, u.translate)("Formulardaten hinzufügen"), onClick: this.toggleOptions }, l.default.createElement("i", { className: "sui-icon-layout sui-sm", "aria-hidden": "true" })), n));
                    var i = "";
    ...
    var i = function() {
        ...
        c = function(e) {
            ...
            return o(t, e), i(t, [{ key: "clearImage", value: function() { "function" == typeof this.props.updateProperty ? (this.props.updateProperty(this.props.property, ""), this.props.updateProperty(this.props.property + "_filename", "")) : (this.props.actions.settingsActions.updateSetting(this.props.property, ""), this.props.actions.settingsActions.updateSetting(this.props.property + "_filename", "")) } }, {
                ...
                value: function() {
                    var e = this,
                        t = wp.media({ title: (0, u.translate)("Bild auswählen"), button: { text: (0, u.translate)("Wählen") }, multiple: !1 }).on("select", function() {
                            var n = void 0,
    ...
    */
            ...
            return i(t, e), s(t, [{ key: "copyToClipboard", value: function() { this.input.select(), document.execCommand("copy"), new p.default({ type: "success", text: (0, c.translate)("Der Shortcode wurde erfolgreich kopiert."), time: 4e3 }).open() } }, {
                ...
                value: function() {
                    var e = this,
                        ...
                        r = (0, c.translate)("Neues Formular erstellen");
                    return "poll" === this.props.type && (r = (0, c.translate)("Neue Umfrage erstellen")), "quiz" === this.props.type && (r = (0, c.translate)("Neuen Test erstellen")), u.default.createElement(u.default.Fragment, null, u.default.createElement("input", { type: "text", defaultValue: "[" + this.data.shortcode + ' id="' + this.props.id + '"]', id: "powerform-form-shortcode", style: { position: "absolute", top: "-1500px" }, "aria-hidden": "true", ref: function(t) { return e.input = t } }), u.default.createElement("div", { className: "true" === this.props.hasLead ? "sui-dropdown fui-dropdown-soon" : "sui-dropdown" }, u.default.createElement("button", { className: "sui-button-icon sui-dropdown-anchor", "aria-label": "Dropdown" }, u.default.createElement("span", { className: "sui-icon-widget-settings-config sui-md", "aria-hidden": "true" }), u.default.createElement("span", { className: "sui-screen-reader-text" }, this.data.dropdownLabel)), u.default.createElement("ul", null, u.default.createElement("li", null, u.default.createElement("button", { className: "powerform-field-edit", onClick: this.copyToClipboard }, u.default.createElement("span", { className: "sui-icon-code", "aria-hidden": "true" }), (0, c.translate)("Shortcode kopieren"))), u.default.createElement("li", null, u.default.createElement("a", { className: "powerform-field-edit", href: this.data.submissions }, u.default.createElement("span", { className: "sui-icon-community-people", "aria-hidden": "true" }), (0, c.translate)("Einsendungen"))), u.default.createElement("li", null, u.default.createElement("form", { method: "post", action: this.data.processAction }, u.default.createElement("input", { type: "hidden", name: "powerform_action", value: "clone" }), u.default.createElement("input", { type: "hidden", name: "id", value: this.props.id }), u.default.createElement("input", { type: "hidden", id: "powerformNonce", name: "powerformNonce", value: this.data.processNonce }), u.default.createElement("input", { type: "hidden", name: "powerformRedirect", value: "false" }), "true" === this.props.hasLead && u.default.createElement("button", { type: "submit", disabled: "disabled", className: "fui-button-with-tag sui-tooltip sui-tooltip-left sui-constrained", "data-tooltip": (0, c.translate)("Duplizieren wird derzeit für die Tests mit aktivierter Lead-Erfassung nicht unterstützt.") }, u.default.createElement("span", { className: "sui-icon-page-multiple", "aria-hidden": "true" }), u.default.createElement("span", { className: "fui-button-label" }, (0, c.translate)("Klonen")), u.default.createElement("span", { className: "sui-tag sui-tag-blue sui-tag-sm" }, (0, c.translate)("Demnächst"))), "true" !== this.props.hasLead && u.default.createElement("button", { type: "submit" }, u.default.createElement("span", { className: "sui-icon-page-multiple", "aria-hidden": "true" }), (0, c.translate)("Klonen")))), u.default.createElement("li", null, u.default.createElement("a", { className: "powerform-field-edit" }, u.default.createElement("span", { className: "sui-icon-update", "aria-hidden": "true" }), (0, c.translate)("Tracking-Reset"))), u.default.createElement("li", null, "true" === this.props.hasLead && u.default.createElement("a", { href: "#", className: "fui-button-with-tag sui-tooltip sui-tooltip-left", "data-tooltip": (0, c.translate)("Der Export wird derzeit für die Tests mit aktivierter Lead-Erfassung nicht unterstützt.") }, u.default.createElement("span", { className: "sui-icon-cloud-migration", "aria-hidden": "true" }), u.default.createElement("span", { className: "fui-button-label" }, (0, c.translate)("Exportieren")), u.default.createElement("span", { className: "sui-tag sui-tag-blue sui-tag-sm" }, (0, c.translate)("Demnächst"))), "true" !== this.props.hasLead && u.default.createElement("a", { className: "powerform-field-edit", href: t }, u.default.createElement("span", { className: "sui-icon-cloud-migration", "aria-hidden": "true" }), (0, c.translate)("Exportieren"))), u.default.createElement("li", null, u.default.createElement("a", { className: "powerform-field-edit sui-option-red", href: n }, u.default.createElement("span", { className: "sui-icon-trash", "aria-hidden": "true" }), (0, c.translate)("Löschen"))))), u.default.createElement("a", { href: powerformData.dashboardUrl + "&createnew=" + this.props.type, className: "sui-button-icon sui-tooltip sui-tooltip-bottom", "data-tooltip": r }, u.default.createElement("span", { className: "sui-icon-plus sui-md", "aria-hidden": "true" })))
                }
            }]), t
        }(l.Component);
    t.default = d
            ...
            return o(t, e), i(t, [{ key: "componentDidMount", value: function() { this.editor = ace.edit("powerform-field-" + this.props.property), this.session = this.editor.getSession(), this.session.setUseWorker(!1), this.editor.setShowPrintMargin(!1), this.session.setMode("ace/mode/css"), this.editor.setTheme("ace/theme/sui"), this.editor.renderer.setShowGutter(!0), this.editor.setHighlightActiveLine(!0), this.editor.focus(), this.editor.on("change", this.updateValue) } }, { key: "componentWillUnmount", value: function() { this.editor.destroy(), this.editor = null } }, {
                ...
                value: function() {
                    var e = this,
                        ...
                        r = l.default.createElement(l.default.Fragment, null, l.default.createElement("label", { className: "sui-label" }, (0, u.translate)("Grundlegende Selektoren")), l.default.createElement("div", { className: "sui-ace-selectors" }, l.default.createElement("a", { className: "sui-selector sui-insert-selector", onClick: function() { return e.insertSelector(" ") } }, (0, u.translate)("Formular")), l.default.createElement("a", { className: "sui-selector sui-insert-selector", onClick: function() { return e.insertSelector(" .powerform-break .powerform-title ") } }, (0, u.translate)("Abschnittsüberschrift")), l.default.createElement("a", { className: "sui-selector sui-insert-selector", onClick: function() { return e.insertSelector(" .powerform-break .powerform-subtitle ") } }, (0, u.translate)("Abschnitt Untertitel")), l.default.createElement("a", { className: "sui-selector sui-insert-selector", onClick: function() { return e.insertSelector(" .powerform-label ") } }, (0, u.translate)("Feldbezeichnung")), l.default.createElement("a", { className: "sui-selector sui-insert-selector", onClick: function() { return e.insertSelector(" .powerform-label--helper ") } }, (0, u.translate)("Feld Beschreibung")), l.default.createElement("a", { className: "sui-selector sui-insert-selector", onClick: function() { return e.insertSelector(" .powerform-input ") } }, (0, u.translate)("Eingabe")), l.default.createElement("a", { className: "sui-selector sui-insert-selector", onClick: function() { return e.insertSelector(" .powerform-textarea ") } }, (0, u.translate)("Textbereich")))),
                        a = l.default.createElement(l.default.Fragment, null, l.default.createElement("label", { className: "sui-label" }, (0, u.translate)("Grundlegende Selektoren")), l.default.createElement("div", { className: "sui-ace-selectors" }, l.default.createElement("a", { className: "sui-selector sui-insert-selector", onClick: function() { return e.insertSelector(" ") } }, (0, u.translate)("Umfrage")), l.default.createElement("a", { className: "sui-selector sui-insert-selector", onClick: function() { return e.insertSelector(" .powerform-poll--question ") } }, (0, u.translate)("Frage")), l.default.createElement("a", { className: "sui-selector sui-insert-selector", onClick: function() { return e.insertSelector(" .powerform-radio--design ") } }, (0, u.translate)("Antworteingabe")), l.default.createElement("a", { className: "sui-selector sui-insert-selector", onClick: function() { return e.insertSelector(" .powerform-radio--label ") } }, (0, u.translate)("Antwortbeschriftung")), l.default.createElement("a", { className: "sui-selector sui-insert-selector", onClick: function() { return e.insertSelector(" .powerform-button ") } }, (0, u.translate)("Senden-Schaltfläche")), l.default.createElement("a", { className: "sui-selector sui-insert-selector", onClick: function() { return e.insertSelector(" .powerform-poll-footer a.powerform-link, .powerform-poll-footer a.powerform-link:visited ") } }, (0, u.translate)("Ergebnis anzeigen Link")))),
                        o = l.default.createElement(l.default.Fragment, null, l.default.createElement("label", { className: "sui-label" }, (0, u.translate)("Grundlegende Selektoren")), l.default.createElement("div", { className: "sui-ace-selectors" }, l.default.createElement("a", { className: "sui-selector sui-insert-selector", onClick: function() { return e.insertSelector(" ") } }, (0, u.translate)("Test")), l.default.createElement("a", { className: "sui-selector sui-insert-selector", onClick: function() { return e.insertSelector(".powerform-quiz--title ") } }, (0, u.translate)("Titel")), l.default.createElement("a", { className: "sui-selector sui-insert-selector", onClick: function() { return e.insertSelector(".powerform-quiz--description p ") } }, (0, u.translate)("Beschreibung")), l.default.createElement("a", { className: "sui-selector sui-insert-selector", onClick: function() { return e.insertSelector(".powerform-question .powerform-legend ") } }, (0, u.translate)("Frage")), l.default.createElement("a", { className: "sui-selector sui-insert-selector", onClick: function() { return e.insertSelector(".powerform-answer .powerform-answer--design ") } }, (0, u.translate)("Antwortcontainer")), l.default.createElement("a", { className: "sui-selector sui-insert-selector", onClick: function() { return e.insertSelector(".powerform-answer .powerform-answer--name ") } }, (0, u.translate)("Antworttext"))));
                ...
                value: function(e, t, n) {
                    ...
                    n && (this.$el.find(".sui-box-body").html('<p class="fui-loading-dialog" aria-label="Loading content"><i class="sui-icon-loader sui-loading" aria-hidden="true"></i></p>'), this.$el.find(".sui-box-footer").html(""), this.$el.find(".integration-header").html("")), this.$el.find(".sui-button:not(.disable-loader)").addClass("sui-button-onload"), this.ajax = jQuery.post({ url: powerformData.ajaxUrl, type: "post", data: e }).done(function(e) {
                        if (e && e.success) {
                            ...
                            n.is_poll && setTimeout(r.request(a.data, a.close, a.loader), 5e3), setTimeout(function() { SUI.suiAccordion(jQuery(".sui-accordion")), SUI.suiTabs(jQuery(".sui-tabs")), jQuery(".sui-2-6-0 select").not(".sui-select").not(".powerform-select").not(".powerform-time").not(".fui-multi-select").each(function() { SUI.suiSelect(jQuery(this)) }), jQuery(".sui-2-6-0 select.sui-select").not(".fui-multi-select").not(".custom-select2").each(function() { jQuery(this).SUIselect2({ dropdownCssClass: "sui-select-dropdown" }) }), SUI.loadCircleScore(jQuery(".sui-circle-score")), SUI.showHidePassword() }, 10);
    ...
    function a(e) { return i.default.createElement("div", { className: "sui-header fui-header-with-settings" }, i.default.createElement("div", { className: "fui-header-title" }, i.default.createElement("h1", { className: "sui-header-title" }, (0, s.translate)("Quiz bearbeiten")), i.default.createElement("div", { className: "sui-actions-right" }, i.default.createElement(u.default, e))), i.default.createElement("div", { className: "fui-header-settings" }, i.default.createElement("div", { className: "sui-actions-left" }, i.default.createElement(f.default, e)), i.default.createElement("div", { className: "sui-actions-right" }, i.default.createElement(u.default, e)))) }
    Object.defineProperty(t, "__esModule", { value: !0 }), t.default = a;
    var o = n(0),
        i = r(o),
        s = n(1),
    ...
    function r(e) { return powerformData.showDocLink ? o.default.createElement("a", { href: "https://n3rds.work/docs/wpmu-dev-plugins/powerform/#quizzes", target: "_blank", className: "sui-button sui-button-ghost" }, o.default.createElement("span", { className: "sui-icon-academy" }), " ", (0, i.translate)("Dokumentation anzeigen")) : "" }
    Object.defineProperty(t, "__esModule", { value: !0 }), t.default = r;
    var a = n(0),
        ...
        h = function(e) {
            ...
            return i(t, e), l(t, [{
                ...
                value: function() {
                    ...
                    return c.default.createElement(c.default.Fragment, null, c.default.createElement("div", { className: "sui-form-field " + n }, c.default.createElement("label", { htmlFor: "powerform-set-title", id: "powerform-set-title-label", className: "sui-screen-reader-text" }, (0, f.translate)("Benenne Dein Formular")), c.default.createElement("input", { type: "text", value: t, placeholder: (0, f.translate)("Gib Deinem Quiz einen Namen"), id: "powerform-set-title", className: "sui-form-control", "aria-labelledby": "powerform-set-title-label", "aria-describedby": "powerform-set-title-message", "aria-required": "true", accessKey: "t", onChange: function(t) { return e.props.actions.navigationActions.updateTitle(t.target.value) } }), c.default.createElement("p", { role: "alert", id: "powerform-set-title-message", className: "sui-error-message", style: { display: _.isEmpty(t) ? "block" : "none", marginBottom: 0 } }, _.isEmpty(t) && (0, f.translate)("Bitte gib einen gültigen Namen ein."))), c.default.createElement(d.default, s({ type: "quiz" }, this.props)))
                }
            }]), t
        }(u.Component);
    t.default = h
    ...
    var i = function() {
        ...
        c = function(e) {
            ...
            return o(t, e), i(t, [{ key: "componentDidMount", value: function() { this.$el = jQuery(this.el), this.$body = jQuery(this.body), this.mounted = !0, this.load(), jQuery(document).off("after.load.powerform"), jQuery(document).on("after.load.powerform", this.previewLoaded) } }, { key: "componentWillUnmount", value: function() { this.mounted = !1 } }, { key: "previewLoaded", value: function() { this.$body.find(".sui-notice-loading").remove(), this.$body.find(".powerform-answer input").prop("disabled", !1).removeAttr("disabled"), this.$body.off("click.powerformPreviewSelect", ".powerform-answer").on("click.powerformPreviewSelect", ".powerform-answer", function(e) { var t = jQuery(this).find('input[type="radio"]'); t.length && (t.prop("checked", !0).trigger("change"), e.preventDefault()) }) } }, {
                key: "load",
                value: function() {
            ...
            }, { key: "render", value: function() { var e = this; return l.default.createElement(l.default.Fragment, null, l.default.createElement("div", { className: "sui-box-header" }, l.default.createElement("h3", { className: "sui-box-title", id: "dialogTitle" }, (0, u.translate)("Vorschau")), l.default.createElement("div", { className: "sui-actions-right" }, l.default.createElement("button", { className: "sui-dialog-close powerform-builder-fields-close", "aria-label": (0, u.translate)("Schließe dieses Dialogfenster"), onClick: this.closeModal }))), l.default.createElement("div", { ref: function(t) { return e.body = t }, className: "sui-box-body" }, l.default.createElement("div", { className: "sui-notice sui-notice-loading" }, l.default.createElement("p", null, (0, u.translate)("Vorschau wird geladen..."))), l.default.createElement("form", { ref: function(t) { return e.el = t }, id: "powerform-module-" + this.props.id, "data-powerform-render": "0", className: "sui-hidden" }))) } }]), t
        }(s.Component);
    t.default = c
}, function(e, t, n) {
    "use strict";
    ...
    var i = function() {
        ...
        c = function(e) {
            ...
            return o(t, e), i(t, [{ key: "render", value: function() { return l.default.createElement(l.default.Fragment, null, l.default.createElement("div", { className: "sui-box-header" }, l.default.createElement("i", { className: "sui-icon-loader sui-loading", "aria-hidden": "true" }), l.default.createElement("h3", { className: "sui-box-title", id: "dialogTitle" }, (0, u.translate)("Quiz wird veröffentlicht..."))), l.default.createElement("div", { className: "sui-box-body" }, l.default.createElement("p", null, (0, u.translate)("Einen kurzen Moment noch, wir veröffentlichen Dein Quiz gerade."))), powerformData.showBranding && l.default.createElement("img", { src: powerformData.imagesUrl + "/powerform-visibility.png", srcSet: powerformData.imagesUrl + "/powerform-visibility.png 1x,\n\t\t\t\t\t\t" + powerformData.imagesUrl + "/powerform-visibility@2x.png 2x", className: "sui-image sui-image-center" })) } }]), t
        }(s.Component);
    t.default = c
}, function(e, t, n) {
    "use strict";
        ...
        c = function(e) {
            ...
            return o(t, e), i(t, [{ key: "trashField", value: function() { this.props.modal.modalProps.trashField(), this.closeModal() } }, { key: "editQuestion", value: function(e) { this.closeModal(), this.props.actions.modalActions.showModal({ open: !0, new: !1, type: "personality", results: this.props.results || {}, question: e.question, closeModal: this.closeModal }, "question") } }, {
                ...
                value: function() {
                    ...
                    if (_.isEmpty(n)) return l.default.createElement(l.default.Fragment, null, l.default.createElement("div", { className: "sui-box-header" }, l.default.createElement("h3", { className: "sui-box-title", id: "dialogTitle" }, (0, u.translate)("%s Persönlichkeit löschen", { args: [t] })), l.default.createElement("button", { className: "sui-dialog-close powerform-builder-fields-close", "aria-label": (0, u.translate)("Schließe dieses Dialogfenster"), onClick: this.closeModal })), l.default.createElement("div", { className: "sui-box-body" }, l.default.createElement("p", null, (0, u.translate)("Möchtest Du diese Persönlichkeit wirklich löschen?"))), l.default.createElement("div", { className: "sui-box-footer" }, l.default.createElement("button", { className: "sui-button sui-button-ghost powerform-discard-field-settings", onClick: this.closeModal }, (0, u.translate)("Abbrechen")), l.default.createElement("button", { className: "sui-button sui-button-ghost sui-button-red", onClick: this.trashField }, l.default.createElement("span", { className: "sui-loading-text" }, l.default.createElement("i", { className: "sui-icon-trash", "aria-hidden": "true" }), (0, u.translate)("Löschen")))));
                    if (!_.isEmpty(n)) { var r = _.map(n, function(t, n) { return l.default.createElement("li", { className: "psource-dropdown--option", key: n }, l.default.createElement("span", { className: "fui-list-label" }, t.title), l.default.createElement("button", { className: "sui-button-icon", onClick: e.editQuestion.bind(e, t) }, l.default.createElement("i", { className: "sui-icon-pencil", "aria-hidden": "true" }), l.default.createElement("span", { className: "sui-screen-reader-text" }, (0, u.translate)("Frage bearbeiten")))) }); return l.default.createElement(l.default.Fragment, null, l.default.createElement("div", { className: "sui-box-header" }, l.default.createElement("h3", { className: "sui-box-title", id: "dialogTitle" }, (0, u.translate)("%s kann nicht gelöscht werden", { args: [t] })), l.default.createElement("button", { className: "sui-dialog-close powerform-builder-fields-close", "aria-label": (0, u.translate)("Schließe dieses Dialogfenster"), onClick: this.closeModal })), l.default.createElement("div", { className: "sui-box-body" }, l.default.createElement("p", null, (0, u.translate)("Bitte entferne den Verweis auf diese Persönlichkeit aus den Fragen in Deinem Test und lösche diesen.")), l.default.createElement("div", { className: "sui-form-field" }, l.default.createElement("label", { className: "sui-label" }, (0, u.translate)("Fragen")), l.default.createElement("ul", { className: "fui-list-fields" }, r))), l.default.createElement("div", { className: "sui-box-footer sui-box-footer-right", style: { paddingTop: "0" } }, l.default.createElement("button", { className: "sui-button powerform-discard-field-settings", onClick: this.closeModal }, (0, u.translate)("Ich habs")))) }
                }
            }]), t
        }(s.Component);
    t.default = c
    ...
    var u = Object.assign || function(e) { for (var t = 1; t < arguments.length; t++) { var n = arguments[t]; for (var r in n) Object.prototype.hasOwnProperty.call(n, r) && (e[r] = n[r]) } return e },
        ...
        O = function(e) {
            ...
            }, { key: "isValid", value: function() { var e = { isValid: !0, error: "" }; if (_.isUndefined(this.state.title) || _.isEmpty(this.state.title)) return e.isValid = !1, e.error = "", e; if (_.isUndefined(this.state.answers) || _.isEmpty(this.state.answers)) return e.isValid = !1, e.error = "", e; var t = _.filter(this.state.answers, function(e) { return !(!_.isEmpty(e.title) || !_.isEmpty(e.image)) }); if (!_.isEmpty(t)) return e.isValid = !1, e.error = (0, d.translate)("Optionen dürfen nicht leer sein. Du musst entweder den Antworttext eingeben oder ein Bild für die leeren Optionen hochladen."), e; if ("knowledge" === this.state.type) { if (!_.some(this.state.answers, function(e) { return e.toggle })) return e.isValid = !1, e.error = (0, d.translate)("Du musst mindestens eine richtige Antwort auswählen, bevor Du diese Frage hinzufügen kannst."), e } if ("nowrong" === this.state.type) { if (_.some(this.state.answers, function(e) { return _.isEmpty(e.result) })) return e.isValid = !1, e.error = (0, d.translate)("Du musst für jede Option eine zugeordnete Persönlichkeit auswählen."), e } return e } }, {
                key: "render",
                value: function() {
    ...
    var u = Object.assign || function(e) { for (var t = 1; t < arguments.length; t++) { var n = arguments[t]; for (var r in n) Object.prototype.hasOwnProperty.call(n, r) && (e[r] = n[r]) } return e },
        ...
        P = function(e) {
            ...
            return l(t, e), c(t, [{ key: "updateProperty", value: function(e, t) { this.setState(o({}, e, t)) } }, {
                ...
                key: "render",
                value: function() {
                    var e = !0 === this.data.new ? (0, d.translate)("Persönlichkeit hinzufügen") : (0, d.translate)("Persönlichkeit bearbeiten"),
                        t = !0 === this.data.new ? (0, d.translate)("Abbrechen") : (0, d.translate)("Änderungen verwerfen"),
                        n = !0 === this.data.new ? (0, d.translate)("Persönlichkeit hinzufügen") : (0, d.translate)("Anwenden");
                    return p.default.createElement(p.default.Fragment, null, p.default.createElement("div", { className: "sui-box-header" }, p.default.createElement("h3", { className: "sui-box-title", id: "dialogTitle" }, e), p.default.createElement("div", { className: "sui-actions-right" }, p.default.createElement("button", { className: "sui-dialog-close powerform-builder-fields-close", "aria-label": (0, d.translate)("Schließe dieses Dialogfenster"), onClick: this.closeModal }))), p.default.createElement("div", { className: "sui-box-body" }, p.default.createElement(m.default, null, p.default.createElement(b.default, { cols: "12" }, p.default.createElement(g.default, u({}, this.props, { settings: this.state, label: (0, d.translate)("Titel"), placeholder: (0, d.translate)("Z.B. Ironman"), updateProperty: this.updateProperty, property: "title", isRequired: !0 })))), p.default.createElement(m.default, null, p.default.createElement(b.default, { cols: "12" }, p.default.createElement(w.default, u({}, this.props, { settings: this.state, type: "image", label: (0, d.translate)("Bild"), fieldClass: "sui-auto", property: "image", updateProperty: this.updateProperty })))), p.default.createElement(m.default, null, p.default.createElement(b.default, { cols: "12" }, p.default.createElement(j.default, u({}, this.props, { settings: this.state, label: (0, d.translate)("Beschreibung"), property: "description", updateProperty: this.updateProperty, disableMiscData: !0, enableFormData: !1, mainOptions: { quiz_name: (0, d.translate)("Test Name"), quiz_answer: (0, d.translate)("Test Antwort"), quiz_result: (0, d.translate)("Test Ergebnis") } }))))), p.default.createElement("div", { className: "sui-box-footer" }, p.default.createElement("button", { className: "sui-button sui-button-ghost powerform-discard-field-settings", onClick: this.closeModal }, p.default.createElement("i", { className: "sui-icon-undo", "aria-hidden": "true" }), t), p.default.createElement("div", { className: "sui-actions-right" }, this.isValid() && p.default.createElement("button", { className: "sui-button powerform-save-field-settings", onClick: this.applyChanges }, p.default.createElement("span", { className: "sui-loading-text" }, p.default.createElement("i", { className: "sui-icon-check", "aria-hidden": "true" }), n), p.default.createElement("i", { className: "sui-icon-loader sui-loading", "aria-hidden": "true" })), !this.isValid() && p.default.createElement("button", { className: "sui-button powerform-save-field-settings sui-tooltip", disabled: "disabled", "data-tooltip": (0, d.translate)("Bitte validiere Deine Felder!") }, p.default.createElement("span", { className: "sui-loading-text" }, p.default.createElement("i", { className: "sui-icon-check", "aria-hidden": "true" }), n), p.default.createElement("i", { className: "sui-icon-loader sui-loading", "aria-hidden": "true" })))))
                }
            }]), t
        }(f.Component);
    t.default = P
            ...
            return l(t, e), c(t, [{ key: "updateProperty", value: function(e, t) { this.setState(o({}, e, t)) } }, { key: "componentWillUnmount", value: function() { this.props.history.push({ pathname: "/notifications/" }) } }, { key: "getNameOptions", value: function() { var e = []; return _.map(powerformData.variables, function(t, n) { e.push({ label: t, value: "{" + n + "}" }) }), e } }, { key: "getEmailOptions", value: function() { var e = []; return _.map(powerformData.variables, function(t, n) { e.push({ label: t, value: "{" + n + "}" }) }), e } }, { key: "getRoutingEmailOptions", value: function() { var e = []; return (0, h.getFields)(this.props.settings.wrappers, ["address", "captcha", "date", "gdprcheckbox", "html", "name", "number", "page-break", "phone", "postdata", "section", "time", "upload", "website", "textarea", "text", "paypal", "stripe", "currency", "calculation", "password", "signature"]).map(function(t) { e.push({ value: "{" + t.element_id + "}", label: t.label }) }), e } }, { key: "getRoutingSubjectOptions", value: function() { var e = []; return (0, h.getFields)(this.props.settings.wrappers, ["address", "captcha", "gdprcheckbox", "html", "page-break", "postdata", "section", "upload", "textarea", "paypal", "stripe", "currency", "calculation", "password", "signature"]).map(function(t) { e.push({ value: "{" + t.element_id + "}", label: t.label }) }), e } }, { key: "getRecipientTagsOptions", value: function() { return { tags: !0, tokenSeparators: [",", " "], language: { searching: function() { return (0, h.translate)("Suchen") }, noResults: function() { return (0, h.translate)("Keine Einträge gefunden") } }, placeholder: (0, h.translate)("Empfänger"), ajax: { url: powerformData.ajaxUrl, type: "POST", delay: 350, data: function(e) { return { action: "powerform_builder_search_emails", _wpnonce: powerformData.searchNonce, q: e.term } }, processResults: function(e) { return { results: e.data } }, cache: !0 }, templateResult: function(e) { return _.isUndefined(e.id) || _.isUndefined(e.text) || _.isUndefined(e.display_name) ? e.text : jQuery("<span><b>" + e.text + "</b> - <small>" + e.display_name + "</small></span>") }, createTag: function(e) { var t = jQuery.trim(e.term); return (0, h.isEmailWp)(t) ? { id: t, text: t } : null } } } }, {
                ...
                value: function() {
                    var e = this,
                        ...
                        a = !0,
                        o = "";
                    "default" === r && _.isEmpty(this.state.recipients) && (a = !1, o = (0, h.translate)("Bitte gib die Empfänger ein")), "routing" === r && (_.isUndefined(this.state.routing) || _.isEmpty(this.state.routing) ? (o = (0, h.translate)("Bitte füge das E-Mail-Routing hinzu"), a = !1) : _.each(this.state.routing, function(e) { _.isEmpty(e.email) && (o = (0, h.translate)("Bitte gib die Empfänger ein"), a = !1), _.isEmpty(e.rule) && (o = (0, h.translate)("Bitte Regel auswählen"), a = !1) })), (_.isUndefined(this.state["email-editor"]) || _.isEmpty(this.state["email-editor"])) && (a = !1, o = (0, h.translate)("Bitte behebe die Fehler auf der Registerkarte E-MAIL.")), (_.isUndefined(this.state["email-subject"]) || _.isEmpty(this.state["email-subject"])) && (a = !1, o = (0, h.translate)("Bitte behebe die Fehler auf der Registerkarte E-MAIL."));
                    var i = !(_.isUndefined(this.props.settings.hasLeads) || !this.props.settings.hasLeads) && "true";
                    return p.default.createElement(p.default.Fragment, null, p.default.createElement("div", { className: "sui-box-header" }, p.default.createElement("h3", { id: "dialogTitle", className: "sui-box-title" }, (0, h.translate)("E-Mail-Benachrichtigung hinzufügen")), p.default.createElement("div", { className: "sui-actions-right" }, p.default.createElement("button", { className: "sui-dialog-close powerform-builder-fields-close", "aria-label": (0, h.translate)("Schließe dieses Dialogfenster"), onClick: this.closeModal }))), p.default.createElement("div", { className: "sui-box-body" }, p.default.createElement("div", { className: "sui-tabs sui-tabs-flushed" }, p.default.createElement("div", { className: "sui-tabs-menu" }, p.default.createElement(d.NavLink, { to: "/notifications/email/", exact: !0, className: "sui-tab-item", activeClassName: "active" }, (0, h.translate)("E-Mail")), p.default.createElement(d.NavLink, { to: "/notifications/recipients/", exact: !0, className: "sui-tab-item", activeClassName: "active" }, (0, h.translate)("Empfänger")), p.default.createElement(d.NavLink, { to: "/notifications/advanced/", exact: !0, className: "sui-tab-item", activeClassName: "active" }, (0, h.translate)("Fortgeschritten")), p.default.createElement(d.NavLink, { to: "/notifications/conditions/", exact: !0, className: "sui-tab-item", activeClassName: "active" }, (0, h.translate)("Bedingungen"))), p.default.createElement(d.Route, { exact: !0, path: "/notifications/", render: function() { return p.default.createElement(d.Redirect, { to: "/notifications/email" }) } }), p.default.createElement("div", { className: "sui-tabs-content" }, p.default.createElement("div", { className: "sui-tab-content active" }, p.default.createElement(d.Route, { path: "/notifications/email", render: function() { return p.default.createElement(p.default.Fragment, null, p.default.createElement(y.default, null, p.default.createElement(v.default, { cols: "12" }, p.default.createElement(E.default, u({}, e.props, { settings: e.state, label: (0, h.translate)("Beschriftung"), description: (0, h.translate)("Das Etikett soll Dir bei der Identifizierung dieser E-Mail helfen und wird nirgendwo in der E-Mail angezeigt."), placeholder: (0, h.translate)("Z.B. Benachrichtigung des Verkaufsteams"), property: "label", updateProperty: e.updateProperty })))), p.default.createElement(y.default, null, p.default.createElement(v.default, { cols: "12" }, p.default.createElement(P.default, u({}, e.props, { settings: e.state, property: "email-subject", placeholder: (0, h.translate)("Z.B. Neues Formular einreichen"), label: (0, h.translate)("Betreff"), required: "true", isRequired: "true", requiredError: (0, h.translate)("Der Betreff der E-Mail darf nicht leer sein"), updateProperty: e.updateProperty }), p.default.createElement("optgroup", { label: (0, h.translate)("Testdaten") }, p.default.createElement("option", { value: "{quiz_name}" }, (0, h.translate)("Test Name")), p.default.createElement("option", { value: "{quiz_answer}" }, (0, h.translate)("Test Antwort")), p.default.createElement("option", { value: "{quiz_result}" }, (0, h.translate)("Test Ergebnis"))), p.default.createElement("optgroup", { label: (0, h.translate)("Lead Daten") }, e.getRoutingSubjectOptions().map(function(e, t) { return p.default.createElement("option", { key: t, value: e.value, "data-content": e.value }, e.label) })), p.default.createElement("optgroup", { label: (0, h.translate)("Verschiedene Daten") }, e.getNameOptions().map(function(e, t) { return p.default.createElement("option", { key: t, value: e.value, "data-content": e.value }, e.label) }))))), p.default.createElement(y.default, null, p.default.createElement(v.default, { cols: "12" }, p.default.createElement(O.default, u({}, e.props, { settings: e.state, property: "email-editor", editorOptions: powerformData.variables, enableFormData: i, enableAllFormFields: i, enableAllNonFormFields: i, boxClass: "sui-tab-boxed", mainOptionsLabel: (0, h.translate)("Test Daten"), mainOptions: { quiz_name: (0, h.translate)("Test Name"), quiz_answer: (0, h.translate)("Test Antwort"), quiz_result: (0, h.translate)("Test Ergebnis") }, wrappers: t, label: (0, h.translate)("Inhalt"), requiredError: (0, h.translate)("Der E-Mail-Inhalt darf nicht leer sein"), updateProperty: e.updateProperty })))), n && p.default.createElement(y.default, null, p.default.createElement(v.default, { cols: "12" }, p.default.createElement(R.default, u({}, e.props, { settings: e.state, property: "email-attachment", defaultValue: "false", label: (0, h.translate)("Anhänge"), description: (0, h.translate)("Wähle aus, ob Du die über die Felder zum Hochladen von Dateien hochgeladenen Dateien an diese E-Mail anhängen möchtest."), updateProperty: e.updateProperty }), p.default.createElement("div", { value: "false" }, (0, h.translate)("Keinen")), p.default.createElement("div", { value: "true" }, (0, h.translate)("Hochgeladene Dateien")))))) } }), p.default.createElement(d.Route, { path: "/notifications/recipients", render: function() { return p.default.createElement(p.default.Fragment, null, p.default.createElement("span", { className: "sui-description", style: { marginTop: "0", marginBottom: "10px" } }, (0, h.translate)("Das Standardverhalten besteht darin, die E-Mail an dieselben Empfänger zu senden. Wenn Du diese E-Mail unter bestimmten Bedingungen an verschiedene Empfänger senden möchtest, kannst Du das E-Mail-Routing aktivieren und die Empfänger dieser E-Mail basierend auf den Benutzereingaben ändern.")), p.default.createElement("div", { className: "sui-form-field", style: { marginTop: "0" } }, p.default.createElement(N.default, u({}, e.props, { property: "email-recipients", default: "default", settings: e.state, updateProperty: e.updateProperty, simple: !0 }), p.default.createElement(C.default, u({}, e.props, { value: "default", label: (0, h.translate)("Standard"), boxClass: "sui-tab-boxed" }), p.default.createElement(P.default, u({}, e.props, { settings: e.state, property: "recipients", placeholder: (0, h.translate)("Z.B. sales@website.com"), label: (0, h.translate)("Empfänger"), required: "true", updateProperty: e.updateProperty, note: (0, h.translate)("Trenne mehrere E-Mails mit einem Komma") }), e.getRoutingEmailOptions().map(function(e, t) { return p.default.createElement("option", { key: t, value: e.value, "data-content": e.value }, e.label) }))), p.default.createElement(C.default, u({}, e.props, { value: "routing", label: (0, h.translate)("E-Mail-Routing") }), p.default.createElement(A.default, u({}, e.props, { updateProperty: e.updateProperty, state: e.state })))))) } }), p.default.createElement(d.Route, { path: "/notifications/advanced", render: function() { return p.default.createElement(p.default.Fragment, null, p.default.createElement(y.default, null, p.default.createElement(v.default, { cols: "12" }, p.default.createElement(P.default, u({}, e.props, { settings: e.state, property: "from-name", placeholder: (0, h.translate)("Gib hier den Namen ein"), label: (0, h.translate)("Von Name"), updateProperty: e.updateProperty }), p.default.createElement("optgroup", { label: (0, h.translate)("Testdaten") }, p.default.createElement("option", { value: "{quiz_name}" }, (0, h.translate)("Test Name")), p.default.createElement("option", { value: "{quiz_answer}" }, (0, h.translate)("Test Antwort")), p.default.createElement("option", { value: "{quiz_result}" }, (0, h.translate)("Test Ergebnis"))), p.default.createElement("optgroup", { label: (0, h.translate)("Lead Daten") }, e.getRoutingSubjectOptions().map(function(e, t) { return p.default.createElement("option", { key: t, value: e.value, "data-content": e.value }, e.label) })), p.default.createElement("optgroup", { label: (0, h.translate)("Verschiedene Daten") }, e.getNameOptions().map(function(e, t) { return p.default.createElement("option", { key: t, value: e.value, "data-content": e.value }, e.label) }))))), p.default.createElement(y.default, null, p.default.createElement(v.default, { cols: "12" }, p.default.createElement(P.default, u({}, e.props, { settings: e.state, property: "form-email", placeholder: (0, h.translate)("Gib Email Absender hier ein"), label: (0, h.translate)("Von Email"), updateProperty: e.updateProperty }), e.getRoutingEmailOptions().map(function(e, t) { return p.default.createElement("option", { key: t, value: e.value, "data-content": e.value }, e.label) })))), p.default.createElement(y.default, null, p.default.createElement(v.default, { cols: "12" }, p.default.createElement(P.default, u({}, e.props, { settings: e.state, property: "replyto-email", placeholder: (0, h.translate)("Gib hier eine Antwort-E-Mail ein"), label: (0, h.translate)("Antwort auf E-Mail"), updateProperty: e.updateProperty }), e.getRoutingEmailOptions().map(function(e, t) { return p.default.createElement("option", { key: t, value: e.value, "data-content": e.value }, e.label) })))), p.default.createElement(y.default, null, p.default.createElement(v.default, { cols: "12" }, p.default.createElement(P.default, u({}, e.props, { settings: e.state, property: "cc-email", placeholder: (0, h.translate)("Gib hier die CC-E-Mail-Adresse ein"), label: (0, h.translate)("CC Emails"), updateProperty: e.updateProperty }), e.getRoutingEmailOptions().map(function(e, t) { return p.default.createElement("option", { key: t, value: e.value, "data-content": e.value }, e.label) })))), p.default.createElement(y.default, null, p.default.createElement(v.default, { cols: "12" }, p.default.createElement(P.default, u({}, e.props, { settings: e.state, property: "bcc-email", placeholder: (0, h.translate)("Gib hier die BCC-E-Mail-Adresse ein"), label: (0, h.translate)("BCC Emails"), updateProperty: e.updateProperty }), e.getRoutingEmailOptions().map(function(e, t) { return p.default.createElement("option", { key: t, value: e.value, "data-content": e.value }, e.label) }))))) } }), p.default.createElement(d.Route, { path: "/notifications/conditions", render: function() { return p.default.createElement(M.default, u({}, e.props, { updateProperty: e.updateProperty, state: e.state })) } }))))), p.default.createElement("div", { className: "sui-box-footer" }, p.default.createElement("button", { className: "sui-button sui-button-ghost powerform-discard-field-settings", onClick: this.closeModal }, p.default.createElement("i", { className: "sui-icon-undo", "aria-hidden": "true" }), (0, h.translate)("Änderungen verwerfen")), p.default.createElement("div", { className: "sui-actions-right" }, a && p.default.createElement("button", { className: "sui-button powerform-save-field-settings", onClick: this.applyChanges }, p.default.createElement("span", { className: "sui-loading-text" }, p.default.createElement("i", { className: "sui-icon-check", "aria-hidden": "true" }), (0, h.translate)("Hinzufügen")), p.default.createElement("i", { className: "sui-icon-loader sui-loading", "aria-hidden": "true" })), !a && p.default.createElement("div", { className: "sui-tooltip", "data-tooltip": o }, p.default.createElement("button", { className: "sui-button powerform-save-field-settings sui-tooltip", disabled: "disabled", "data-tooltip": o }, p.default.createElement("span", { className: "sui-loading-text" }, p.default.createElement("i", { className: "sui-icon-check", "aria-hidden": "true" }), (0, h.translate)("Hinzufügen")), p.default.createElement("i", { className: "sui-icon-loader sui-loading", "aria-hidden": "true" }))))))
                }
            }]), t
        }(f.Component);
    t.default = D
            ...
            return i(t, e), l(t, [{ key: "removeRule", value: function() { this.props.removeRule(this.props.counter) } }, { key: "updateField", value: function(e, t) { this.props.updateField(this.props.counter, t) } }, { key: "updateRule", value: function(e, t) { this.props.updateRule(this.props.counter, t) } }, { key: "updateValue", value: function(e) { this.props.updateValue(this.props.counter, e.target.value) } }, { key: "updateInputValue", value: function(e, t) { this.props.updateInputValue(this.props.counter, t) } }, { key: "toggleState", value: function() { this.setState({ open: !this.state.open }) } }, { key: "disableSearch", value: function() { return { minimumResultsForSearch: -1 } } }, {
                ...
                value: function() {
                    var e = this,
                        ...
                        o = _.isUndefined(this.props.rule.element_id) || "final_result" !== this.props.rule.element_id ? a : (0, f.translate)("Endergebnis"),
                    ...
                    return c.default.createElement("div", { className: "sui-box fui-visibility-rule" + (!0 === this.state.open ? " fui-open" : "") }, c.default.createElement("h4", { className: "fui-visibility-rule-header" }, c.default.createElement("button", { id: "powerform-field-" + t, className: "sui-box-header", "aria-controls": "powerform-field-" + t + "-content", "aria-expanded": this.state.open, onClick: function() { return e.toggleState() } }, c.default.createElement("i", { className: "sui-icon-link fui-visibility-rule-icon", "aria-hidden": "true" }), c.default.createElement("span", { className: "fui-visibility-rule-text" }, c.default.createElement("strong", null, o), " ", (0, f.getRuleLabel)(this.props.rule.rule, n.field_type), " ", c.default.createElement("strong", null, i)), c.default.createElement("i", { className: "sui-icon-chevron-down fui-visibility-rule-arrow", "aria-hidden": "true" }))), c.default.createElement("div", { role: "region", id: "powerform-field-" + t + "-content", className: "sui-box-body fui-visibility-rule-body", "aria-labelledby": "powerform-field-" + t, "aria-hidden": !0 !== this.state.open }, c.default.createElement(g.default, s({}, this.props, { elementId: t + "-field", property: "element_id", updateProperty: this.updateField, settings: this.props.rule, label: (0, f.translate)("Feld") }), !_.isEmpty(this.fields) && c.default.createElement("optgroup", { label: (0, f.translate)("Formulardaten") }, _.map(this.fields, function(e, t) { return c.default.createElement("option", { value: e.element_id, key: t }, e.label, " | ", e.element_id) })), !_.isEmpty(this.questions) && c.default.createElement("optgroup", { label: (0, f.translate)("Test Daten") }, _.map(this.questions, function(e, t) { return c.default.createElement("option", { value: e.slug, key: t }, e.title, " | ", e.slug) }), c.default.createElement("option", { value: "final_result" }, (0, f.translate)("Endergebnis")))), c.default.createElement(d.default, null, c.default.createElement(m.default, { cols: "6" }, c.default.createElement(w.default, s({}, this.props, { elementId: t + "-condrule", settings: this.props.rule, property: "rule", updateProperty: this.updateRule, label: (0, f.translate)("Bedingung (erforderlich)"), options: this.disableSearch() }), c.default.createElement("option", { value: "" }, (0, f.translate)("Regel auswählen")), !_.isEmpty(r) && c.default.createElement(c.default.Fragment, null, c.default.createElement("option", { value: "is_correct" }, (0, f.translate)("Ist richtig")), c.default.createElement("option", { value: "is_incorrect" }, (0, f.translate)("Ist falsch"))), "final_result" === this.props.rule.element_id && c.default.createElement(c.default.Fragment, null, c.default.createElement("option", { value: "contains" }, (0, f.translate)("Enthält")), c.default.createElement("option", { value: "is_great" }, (0, f.translate)("größer als")), c.default.createElement("option", { value: "is_less" }, (0, f.translate)("kleiner als"))), "checkbox" === n.field_type && _.isEmpty(r) && "final_result" !== this.props.rule.element_id && c.default.createElement(c.default.Fragment, null, c.default.createElement("option", { value: "is" }, (0, f.translate)("Hat")), c.default.createElement("option", { value: "is_not" }, (0, f.translate)("Hat nicht"))), "signature" === n.field_type && _.isEmpty(r) && "final_result" !== this.props.rule.element_id && c.default.createElement(c.default.Fragment, null, c.default.createElement("option", { value: "is" }, (0, f.translate)("Ist Null")), c.default.createElement("option", { value: "is_not" }, (0, f.translate)("Ist nicht null"))), "checkbox" !== n.field_type && "signature" !== n.field_type && _.isEmpty(r) && "final_result" !== this.props.rule.element_id && c.default.createElement(c.default.Fragment, null, c.default.createElement("option", { value: "is" }, (0, f.translate)("Ist")), c.default.createElement("option", { value: "is_not" }, (0, f.translate)("Ist nicht"))), n.isNumber && _.isEmpty(r) && "final_result" !== this.props.rule.element_id && c.default.createElement(c.default.Fragment, null, c.default.createElement("option", { value: "is_great" }, (0, f.translate)("Ist größer")), c.default.createElement("option", { value: "is_less" }, (0, f.translate)("Ist kleiner"))), !n.isNumber && !n.hasOptions && "signature" !== n.field_type && _.isEmpty(r) && "final_result" !== this.props.rule.element_id && c.default.createElement(c.default.Fragment, null, c.default.createElement("option", { value: "contains" }, (0, f.translate)("Enthält")), c.default.createElement("option", { value: "starts" }, (0, f.translate)("Startet")), c.default.createElement("option", { value: "ends" }, (0, f.translate)("Endet"))), "date" === n.field_type && ("date-day" === n.field_slug || "date" === n.field_slug) && _.isEmpty(r) && "final_result" !== this.props.rule.element_id && c.default.createElement(c.default.Fragment, null, c.default.createElement("option", { value: "day_is" }, (0, f.translate)("Tag ist")), c.default.createElement("option", { value: "day_is_not" }, (0, f.translate)("Tag ist nicht"))), "date" === n.field_type && "signature" !== n.field_type && ("date-month" === n.field_slug || "date" === n.field_slug) && _.isEmpty(r) && "final_result" !== this.props.rule.element_id && c.default.createElement(c.default.Fragment, null, c.default.createElement("option", { value: "month_is" }, (0, f.translate)("Monat ist")), c.default.createElement("option", { value: "month_is_not" }, (0, f.translate)("Monat ist nicht"))))), c.default.createElement(m.default, { cols: "6" }, n.hasOptions && c.default.createElement(c.default.Fragment, null, c.default.createElement("label", { className: "sui-label" }, " "), c.default.createElement("select", { className: "fui-select", value: this.props.rule.value, onChange: this.updateValue.bind(this) }, c.default.createElement("option", { value: "" }, (0, f.translate)("Wähle Option")), _.map(n.values, function(e, t) { return c.default.createElement("option", { value: e.value, key: t }, e.label) }))), !n.hasOptions && "signature" !== n.field_type && (!u.includes(this.props.rule.rule) || "date" !== n.field_type) && _.isEmpty(r) && c.default.createElement(b.default, s({}, this.props, { settings: this.props.rule, inputId: t + "-value", property: "value", updateProperty: this.updateInputValue, label: (0, f.translate)("Wert") })), !n.hasOptions && "date" === n.field_type && ("month_is" === this.props.rule.rule === "month_is" || "month_is_not" === this.props.rule.rule) && c.default.createElement(c.default.Fragment, null, c.default.createElement("label", { className: "sui-label" }, " "), c.default.createElement("select", { className: "fui-select", value: this.props.rule.value, onChange: this.updateValue.bind(this) }, c.default.createElement("option", { value: "" }, (0, f.translate)("Wähle Monat")), _.map(l, function(e) { return c.default.createElement("option", { value: e, key: e }, e) }))), !n.hasOptions && "date" === n.field_type && ("day_is" === this.props.rule.rule || "day_is_not" === this.props.rule.rule) && c.default.createElement(c.default.Fragment, null, c.default.createElement("label", { className: "sui-label" }, " "), c.default.createElement("select", { className: "fui-select", value: this.props.rule.value, onChange: this.updateValue.bind(this) }, c.default.createElement("option", { value: "" }, (0, f.translate)("Tag auswählen")), _.map(p, function(e) { return c.default.createElement("option", { value: e, key: e }, e) }))))), c.default.createElement("div", { className: "fui-visibility-rule-footer" }, c.default.createElement("button", { className: "sui-button sui-button-red sui-button-ghost", onClick: this.removeRule.bind(this) }, c.default.createElement("i", { className: "sui-icon-trash", "aria-hidden": "true" }), (0, f.translate)("Löschen")), c.default.createElement("button", { className: "sui-button sui-button-ghost", onClick: function() { return e.toggleState() } }, (0, f.translate)("Erledigt")))))
                }
            }]), t
        }(u.Component);
    t.default = O
    ...
    var i = function() {
        ...
        c = function(e) {
            function t(e) { r(this, t); var n = a(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this, e)); return n.closeModal = n.props.modal.modalProps.closeModal.bind(n), n.trashField = n.trashField.bind(n), n }
            return o(t, e), i(t, [{ key: "trashField", value: function() { this.props.modal.modalProps.trashField(), this.closeModal() } }, { key: "render", value: function() { return l.default.createElement(l.default.Fragment, null, l.default.createElement("div", { className: "sui-box-header sui-block-content-center" }, l.default.createElement("h3", { className: "sui-box-title", id: "dialogTitle" }, (0, u.translate)("Benachrichtigung löschen")), l.default.createElement("button", { className: "sui-dialog-close powerform-builder-fields-close", "aria-label": (0, u.translate)("Schließe dieses Dialogfenster"), onClick: this.closeModal })), l.default.createElement("div", { className: "sui-box-body sui-box-body-slim sui-block-content-center" }, l.default.createElement("p", { className: "sui-description" }, (0, u.translate)("Möchtest Du diese Benachrichtigung wirklich löschen?"))), l.default.createElement("div", { className: "sui-box-footer sui-box-footer-center", style: { paddingTop: "0" } }, l.default.createElement("button", { className: "sui-button sui-button-ghost powerform-discard-field-settings", onClick: this.closeModal }, (0, u.translate)("Abbrechen")), l.default.createElement("button", { className: "sui-button sui-button-ghost sui-button-red", onClick: this.trashField }, l.default.createElement("span", { className: "sui-loading-text" }, l.default.createElement("i", { className: "sui-icon-trash", "aria-hidden": "true" }), (0, u.translate)("LÖSCHEN"))))) } }]), t
        }(s.Component);
    t.default = c
}, function(e, t, n) {
    "use strict";
    ...
    var i = function() {
        ...
        c = function(e) {
            ...
            }, { key: "componentWillUnmount", value: function() { this.$el.off("change", this.updateValue), this.$el.unbind().removeData() } }, { key: "render", value: function() { var e = this; return l.default.createElement("div", { className: "sui-form-field sui-sidenav-hide-lg" }, l.default.createElement("label", { className: "sui-label" }, (0, u.translate)("Navigieren")), l.default.createElement("select", { className: "sui-mobile-nav", ref: function(t) { return e.el = t } }, this.props.children)) } }]), t
        }(s.Component);
    t.default = c
}, function(e, t, n) {
    "use strict";
            ...
            return i(t, e), l(t, [{
                ...
                value: function(e, t) {
                    ...
                    d.default.post(powerformData.ajaxUrl, m.default.stringify(e)).then(function(a) {
                        ...
                        else { new b.default({ type: "error", text: (0, f.translate)("Beim Speichern Deines Formulars ist ein Fehler aufgetreten. Bitte versuche es erneut.") }).open() }
                        n.setState({ publishLoading: !1, draftLoading: !1 })
                    }).catch(function(e) { new b.default({ type: "error", text: (0, f.translate)("Beim Speichern Deines Formulars ist ein Fehler aufgetreten. Bitte versuche es erneut.") }).open(), console.log(e), n.setState({ publishLoading: !1, draftLoading: !1 }) })
                }
    ...
    var i = function() {
        ...
        c = function(e) {
            ...
            return o(t, e), i(t, [{ key: "closeModal", value: function(e) { this.props.actions.modalActions.showModal({ open: !1, title: (0, u.translate)("Vorschau") }, "preview"), jQuery("#powerform-quiz-styles-" + this.props.id).remove() } }, { key: "openModal", value: function(e) { this.props.actions.modalActions.showModal({ open: !0, title: (0, u.translate)("Vorschau"), closeModal: this.closeModal }, "preview") } }, { key: "render", value: function() { return l.default.createElement("button", { id: "powerform-preview-button", className: "sui-button sui-sidenav-hide-md", accessKey: "p", onClick: this.openModal, disabled: this.props.disabled }, l.default.createElement("i", { className: "sui-icon-eye", "aria-hidden": "true" }), " ", (0, u.translate)("Vorschau")) } }]), t
        }(s.Component);
    t.default = c
}, function(e, t, n) {
    "use strict";
        ...
        d = function(e) {
            ...
            return i(t, e), s(t, [{ key: "componentDidMount", value: function() { jQuery("html, body").animate({ scrollTop: 0 }, "fast") } }, {
                ...
                value: function() {
                    var e = this,
                        t = function(t) { e.props.history.push("/" + t) };
                    return u.default.createElement("div", { id: "powerform-form-fields", className: "sui-box" }, u.default.createElement("div", { className: "sui-box-header" }, u.default.createElement("h2", { className: "sui-box-title" }, (0, c.translate)("Fragen"))), u.default.createElement("div", { className: "sui-box-body" }, u.default.createElement(p.default, this.props)), u.default.createElement("div", { className: "sui-box-footer" }, "knowledge" === this.props.type && u.default.createElement("button", { className: "sui-button", onClick: function() { return t("") } }, u.default.createElement("i", { className: "sui-icon-arrow-left", "aria-hidden": "true" }), (0, c.translate)("Einführung")), "personality" === this.props.type && u.default.createElement("button", { className: "sui-button", onClick: function() { return t("personalities") } }, u.default.createElement("i", { className: "sui-icon-arrow-left", "aria-hidden": "true" }), (0, c.translate)("Persönlichkeiten")), u.default.createElement("div", { className: "sui-actions-right" }, this.props.hasLead && u.default.createElement("button", { className: "sui-button sui-button-icon-right", onClick: function() { return t("leads") } }, (0, c.translate)("Leads"), u.default.createElement("i", { className: "sui-icon-arrow-right", "aria-hidden": "true" })), !this.props.hasLead && u.default.createElement("button", { className: "sui-button sui-button-icon-right", onClick: function() { return t("appearance") } }, (0, c.translate)("Aussehen"), u.default.createElement("i", { className: "sui-icon-arrow-right", "aria-hidden": "true" })))))
                }
            }]), t
        }(l.Component);
    t.default = d
    ...
    var s = function() {
        ...
        f = function(e) {
            ...
            }, { key: "render", value: function() { var e = ""; return _.isUndefined(this.props.question.image) || _.isEmpty(this.props.question.image) || (e = "url(" + this.props.question.image + ")"), u.default.createElement("div", { className: "sui-builder-field sui-react sui-can_move" }, u.default.createElement("div", { className: "sui-field-info", onClick: this.editModal }, u.default.createElement("i", { className: "sui-icon-drag", "aria-hidden": "true" }), u.default.createElement("div", { className: "sui-builder-field-label" }, u.default.createElement("div", { className: "sui-builder-field-image", "aria-hidden": "true" }, u.default.createElement("span", { style: { backgroundImage: e } })), u.default.createElement("span", null, this.props.question.title))), u.default.createElement("div", { className: "sui-field-actions" }, u.default.createElement("div", { className: "sui-dropdown" }, u.default.createElement("button", { className: "sui-button-icon sui-dropdown-anchor" }, u.default.createElement("i", { className: "sui-icon-widget-settings-config", "aria-hidden": "true" }), u.default.createElement("span", { className: "sui-screen-reader-text" }, (0, c.translate)("Feldeinstellungen öffnen"))), u.default.createElement("ul", null, u.default.createElement("li", null, u.default.createElement("button", { onClick: this.editModal }, u.default.createElement("i", { className: "sui-icon-pencil", "aria-hidden": "true" }), (0, c.translate)("Bearbeiten"))), u.default.createElement("li", null, u.default.createElement("button", { onClick: this.duplicateQuestion }, u.default.createElement("i", { className: "sui-icon-copy", "aria-hidden": "true" }), (0, c.translate)("Klonen"))), u.default.createElement("li", null, u.default.createElement("button", { className: "sui-option-red", onClick: this.deleteQuestion }, u.default.createElement("i", { className: "sui-icon-trash", "aria-hidden": "true" }), (0, c.translate)("Löschen"))))))) } }]), t
        }(l.Component);
    t.default = f
}, function(e, t, n) {
    "use strict";
    ...
    var i = function() {
        ...
        c = function(e) {
            ...
            return o(t, e), i(t, [{ key: "closeModal", value: function() { this.props.actions.modalActions.showModal({ open: !1 }, "submit") } }, { key: "editSettings", value: function() { this.props.actions.modalActions.showModal({ open: !0, closeModal: this.closeModal }, "submit") } }, { key: "render", value: function() { var e = _.isUndefined(this.props.settings.submitData) || _.isUndefined(this.props.settings.submitData["button-text"]) || !this.props.settings.submitData["button-text"] ? (0, u.translate)("Einreichen") : this.props.settings.submitData["button-text"]; return l.default.createElement("div", { className: "sui-box-builder-footer sui-fields-boxed" }, l.default.createElement("div", { className: "sui-builder-field sui-react sui-can_open" }, l.default.createElement("div", { onClick: this.editSettings, className: "sui-field-info" }, l.default.createElement("div", { className: "sui-builder-field-label" }, l.default.createElement("i", { className: "sui-icon-check", "aria-hidden": "true" }), l.default.createElement("span", null, e))), l.default.createElement("div", { className: "sui-field-actions" }, l.default.createElement("div", { className: "sui-dropdown" }, l.default.createElement("button", { className: "sui-button-icon", onClick: this.editSettings }, l.default.createElement("i", { className: "sui-icon-widget-settings-config", "aria-hidden": "true" }), l.default.createElement("span", { className: "sui-screen-reader-text" }, (0, u.translate)("Feldeinstellungen öffnen"))))))) } }]), t
        }(s.Component);
    t.default = c
}, function(e, t, n) {
    "use strict";
        ...
        w = function(e) {
            ...
            return i(t, e), l(t, [{ key: "componentDidMount", value: function() { jQuery("html, body").animate({ scrollTop: 0 }, "fast") } }, {
                ...
                value: function() {
                    var e = this,
                        t = function(t) { e.props.history.push("/" + t) };
                    return c.default.createElement("div", { id: "powerform-form-fields", className: "sui-box" }, c.default.createElement("div", { className: "sui-box-header" }, c.default.createElement("h2", { className: "sui-box-title" }, (0, f.translate)("Leads"))), c.default.createElement("div", { className: "sui-box-body" }, c.default.createElement(b.default, { label: (0, f.translate)("Leads erfassen"), description: (0, f.translate)("Sammle die Daten Deiner Teilnehmer, z. B. Name oder E-Mail, indem Du ein Lead-Formular in Dein Quiz einbindest.") }, c.default.createElement("div", { className: "sui-form-field" }, c.default.createElement("h4", { className: "sui-settings-label" }, (0, f.translate)("Lead-Generierungsformular")), c.default.createElement("p", { className: "sui-description", style: { marginBottom: "10px" } }, (0, f.translate)("Passe das Standardformular für die Lead-Generierung über die Schaltfläche Bearbeiten unten an. Beachte, dass dieses Lead-Generierungsformular nur begrenzte Einstellungen hat und die restlichen Einstellungen entweder automatisch von diesem Test festgelegt werden oder von diesem Test und dem Lead-Generierungsformular gemeinsam genutzt werden (z.B. E-Mail-Benachrichtigungen, Integrationen usw.).")), c.default.createElement("div", { className: "fui-recipient" }, c.default.createElement("span", { className: "sui-icon-clipboard-notes sui-lg", "aria-hidden": "true" }), c.default.createElement("p", null, (0, f.translate)("%s - Leads-Formular", { args: [this.props.settings.formName] })), c.default.createElement("div", { className: "sui-tooltip", "data-tooltip": (0, f.translate)("Formular bearbeiten") }, c.default.createElement("a", { href: powerformData.formEditUrl + "&id=" + this.props.leadsForm, target: "_blank", className: "sui-icon-button" }, c.default.createElement("span", { className: "sui-icon-pencil", "aria-hidden": "true" }), c.default.createElement("span", { className: "sui-screen-reader-text" }, (0, f.translate)("Bearbeiten")))))), c.default.createElement(g.default, s({}, this.props, { property: "form-placement", default: "beginning", settingsLabel: (0, f.translate)("Formularplatzierung"), settingsDesc: (0, f.translate)("Wo möchtest Du das Lead-Formular in Deinem Quiz einblenden?") }), c.default.createElement(d.default, { value: "beginning" }, (0, f.translate)("Am Anfang des Quiz")), c.default.createElement(d.default, { value: "end" }, (0, f.translate)("Vor dem Anzeigen der Ergebnisse"))), c.default.createElement(g.default, s({}, this.props, { property: "skip-form", default: "", settingsLabel: (0, f.translate)("Formular überspringen"), settingsDesc: (0, f.translate)("Aktiviere diese Option, wenn Du Deinen Teilnehmern erlauben möchtest, das Formular zu überspringen.") }), c.default.createElement(m.default, { value: "true", boxClass: "sui-tab-boxed", label: (0, f.translate)("Aktivieren") }, c.default.createElement(E.default, s({}, this.props, { label: (0, f.translate)("Linktext"), placeholder: (0, f.translate)("Überspringen und fortfahren"), property: "skip-text" }))), c.default.createElement(d.default, { value: "" }, (0, f.translate)("Deaktivieren"))))), c.default.createElement("div", { className: "sui-box-footer" }, c.default.createElement("button", { className: "sui-button", onClick: function() { return t("questions") } }, c.default.createElement("i", { className: "sui-icon-arrow-left", "aria-hidden": "true" }), (0, f.translate)("Fragen")), c.default.createElement("div", { className: "sui-actions-right" }, c.default.createElement("button", { className: "sui-button sui-button-icon-right", onClick: function() { return t("appearance") } }, (0, f.translate)("Aussehen"), c.default.createElement("i", { className: "sui-icon-arrow-right", "aria-hidden": "true" })))))
                }
            }]), t
        }(u.Component);
    t.default = w
    ...
    var i = function() {
        ...
        c = function(e) {
            function t(e) { return r(this, t), a(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this, e)) }
            return o(t, e), i(t, [{ key: "render", value: function() { return l.default.createElement("div", { className: "fui-demo fui-demo--quiz fui-demo--default" }, l.default.createElement("span", null, (0, u.translate)("Fragetext?")), l.default.createElement("label", null, l.default.createElement("input", { type: "radio", readOnly: !0 }), l.default.createElement("span", null, l.default.createElement("span", { "aria-hidden": "true" }), l.default.createElement("span", null, (0, u.translate)("Option abgewählt")))), l.default.createElement("label", null, l.default.createElement("input", { type: "radio", checked: "checked", readOnly: !0 }), l.default.createElement("span", null, l.default.createElement("span", { "aria-hidden": "true" }), l.default.createElement("span", null, (0, u.translate)("Option ausgewählt"))))) } }]), t
        }(s.Component);
    t.default = c
}, function(e, t, n) {
    "use strict";
    ...
    var i = function() {
        ...
        c = function(e) {
            function t(e) { return r(this, t), a(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this, e)) }
            return o(t, e), i(t, [{ key: "render", value: function() { return l.default.createElement("div", { className: "fui-demo fui-demo--quiz fui-demo--flat" }, l.default.createElement("span", null, (0, u.translate)("Fragetext?")), l.default.createElement("label", null, l.default.createElement("input", { type: "radio", readOnly: !0 }), l.default.createElement("span", null, l.default.createElement("span", { "aria-hidden": "true" }), l.default.createElement("span", null, (0, u.translate)("Option abgewählt")))), l.default.createElement("label", null, l.default.createElement("input", { type: "radio", checked: "checked", readOnly: !0 }), l.default.createElement("span", null, l.default.createElement("span", { "aria-hidden": "true" }), l.default.createElement("span", null, (0, u.translate)("Option ausgewählt"))))) } }]), t
        }(s.Component);
    t.default = c
}, function(e, t, n) {
    "use strict";
    ...
    var i = function() {
        ...
        c = function(e) {
            function t(e) { return r(this, t), a(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this, e)) }
            return o(t, e), i(t, [{ key: "render", value: function() { return l.default.createElement("div", { className: "fui-demo fui-demo--quiz fui-demo--bold" }, l.default.createElement("span", null, (0, u.translate)("Fragetext?")), l.default.createElement("label", null, l.default.createElement("input", { type: "radio", readOnly: !0 }), l.default.createElement("span", null, l.default.createElement("span", { "aria-hidden": "true" }), l.default.createElement("span", null, (0, u.translate)("Option abgewählt")))), l.default.createElement("label", null, l.default.createElement("input", { type: "radio", checked: "checked", readOnly: !0 }), l.default.createElement("span", null, l.default.createElement("span", { "aria-hidden": "true" }), l.default.createElement("span", null, (0, u.translate)("Option ausgewählt"))))) } }]), t
        }(s.Component);
    t.default = c
}, function(e, t, n) {
    "use strict";
    ...
    var i = function() {
        ...
        c = function(e) {
            function t(e) { return r(this, t), a(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this, e)) }
            return o(t, e), i(t, [{ key: "render", value: function() { return l.default.createElement("div", { className: "fui-demo fui-demo--quiz fui-demo--material" }, l.default.createElement("span", null, (0, u.translate)("Fragetext?")), l.default.createElement("label", null, l.default.createElement("input", { type: "radio", readOnly: !0 }), l.default.createElement("span", null, l.default.createElement("span", { "aria-hidden": "true" }), l.default.createElement("span", null, (0, u.translate)("Option abgewählt")))), l.default.createElement("label", null, l.default.createElement("input", { type: "radio", checked: "checked", readOnly: !0 }), l.default.createElement("span", null, l.default.createElement("span", { "aria-hidden": "true" }), l.default.createElement("span", null, (0, u.translate)("Option ausgewählt"))))) } }]), t
        }(s.Component);
    t.default = c
}, function(e, t, n) {
    "use strict";
    ...
    var i = function() {
        ...
        c = function(e) {
            function t(e) { return r(this, t), a(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this, e)) }
            return o(t, e), i(t, [{ key: "render", value: function() { return l.default.createElement("div", { className: "sui-notice" }, l.default.createElement("p", null, (0, u.translate)("Du hast entschieden, dass kein Stylesheet in die Warteschlange gestellt werden soll. Der Test erbt Stile aus dem CSS Deines Themes."))) } }]), t
        }(s.Component);
    t.default = c
}, function(e, t, n) {
    "use strict";
    ...
    var s = Object.assign || function(e) { for (var t = 1; t < arguments.length; t++) { var n = arguments[t]; for (var r in n) Object.prototype.hasOwnProperty.call(n, r) && (e[r] = n[r]) } return e },
        ...
        w = function(e) {
            function t() { return a(this, t), o(this, (t.__proto__ || Object.getPrototypeOf(t)).apply(this, arguments)) }
            return i(t, e), l(t, [{ key: "render", value: function() { return c.default.createElement(d.default, { label: (0, f.translate)("Layout"), description: (0, f.translate)("Passe Dein Testlayout an, indem Du das Antwortlayout und die allgemeine Testausrichtung anpasst.") }, c.default.createElement(m.default, s({}, this.props, { property: "visual_style", settingsLabel: (0, f.translate)("Antworten"), settingsDesc: (0, f.translate)("Wähle aus, ob die Testantworten in einer Liste oder einem Raster angezeigt werden sollen."), radioClass: "sui-radio-sm", radioContent: "true" }), c.default.createElement(g.default, { value: "list", hasImage: !0, image1x: "quiz-list.png", image2x: "quiz-list@2x.png", label: (0, f.translate)("Liste") }), c.default.createElement("div", { value: "grid", hasImage: !0, image1x: "quiz-grid.png", image2x: "quiz-grid@2x.png", label: (0, f.translate)("Raster") }, c.default.createElement("p", { className: "sui-description", style: { marginBottom: "20px" } }, (0, f.translate)("Wähle die Anzahl der Spalten, die in eine Zeile passen sollen. Beachte, dass sich das Rasterlayout in der Liste auf kleineren Bildschirmen ändert, sodass die kleineren Bildschirme davon nicht betroffen sind.")), c.default.createElement(E.default, s({}, this.props, { property: "quiz-grid-cols", defaultValue: "3", label: (0, f.translate)("Spalten pro Zeile"), fieldSize: "100" }), c.default.createElement("option", { value: "2" }, "2"), c.default.createElement("option", { value: "3" }, "3"), c.default.createElement("option", { value: "4" }, "4"), c.default.createElement("option", { value: "5" }, "5"), c.default.createElement("option", { value: "6" }, "6")))), "none" !== this.props.quizDesign && c.default.createElement(b.default, s({}, this.props, { property: "quiz-alignment", default: "grid" === this.props.quizLayout ? "center" : "left", settingsLabel: (0, f.translate)("Testausrichtung"), settingsDesc: (0, f.translate)("Wähle die Gesamtausrichtung Deines Test. Diese Einstellung wirkt sich auf alles aus, einschließlich Titel, Beschreibung, Fragen und Antworten, Schaltflächen und Social-Share-Nachricht.") }), c.default.createElement(g.default, { value: "left" }, (0, f.translate)("Links")), c.default.createElement(g.default, { value: "center" }, (0, f.translate)("Zentriert")), c.default.createElement(g.default, { value: "right" }, (0, f.translate)("Rechts")))) } }]), t
        }(u.Component);
    t.default = w
}, function(e, t, n) {
    "use strict";
    ...
    var s = Object.assign || function(e) { for (var t = 1; t < arguments.length; t++) { var n = arguments[t]; for (var r in n) Object.prototype.hasOwnProperty.call(n, r) && (e[r] = n[r]) } return e },
        ...
        x = function(e) {
            function t(e) { return a(this, t), o(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this, e)) }
            return i(t, e), l(t, [{ key: "render", value: function() { return c.default.createElement(d.default, { label: (0, f.translate)("Test Container"), description: (0, f.translate)("Passe den Testcontainer nach Deinen Wünschen an.") }, c.default.createElement(m.default, s({}, this.props, { property: "quiz-padding", default: "none", settingsLabel: (0, f.translate)("Innenabstand"), settingsDesc: (0, f.translate)("Standardmäßig füllt der Test den verfügbaren Platz, an dem Du ihn einfügst. Du kannst hier etwas Polsterung hinzufügen, um besser zu Deinem Theme zu passen.") }), c.default.createElement(b.default, { value: "none" }, (0, f.translate)("Keinen")), c.default.createElement(g.default, s({}, this.props, { value: "custom", label: (0, f.translate)("Benutzerdefiniert"), boxClass: "sui-border-frame" }))), c.default.createElement(m.default, s({}, this.props, { property: "quiz-border", default: "none", settingsLabel: (0, f.translate)("Rahmen"), settingsDesc: (0, f.translate)("Füge dem Test einen optionalen Rahmen hinzu.") }), c.default.createElement(b.default, { value: "none" }, (0, f.translate)("Keinen")), c.default.createElement(E.default, s({}, this.props, { value: "custom", label: (0, f.translate)("Benutzerdefiniert"), boxClass: "sui-border-frame" }))), c.default.createElement(m.default, s({}, this.props, { property: "quiz-spacing", default: "default", settingsLabel: (0, f.translate)("Abstand"), settingsDesc: (0, f.translate)("Wähle aus, wie viel Abstand Du zwischen den einzelnen Testfragen haben möchtest.") }), c.default.createElement(b.default, { value: "default" }, (0, f.translate)("Komfortabel")), c.default.createElement(b.default, { value: "enclosed" }, (0, f.translate)("Kompakt")), c.default.createElement(O.default, s({}, this.props, { value: "custom", label: (0, f.translate)("Benutzerdefiniert"), boxClass: "sui-border-frame" }))), c.default.createElement(m.default, s({}, this.props, { property: "quiz-size", default: "custom", settingsLabel: (0, f.translate)("Maximale Breite"), settingsDesc: (0, f.translate)("Wähle die maximale Behälterbreite für Deinen Test. Volle Breite bedeutet, dass der Quizcontainer den zu 100% verfügbaren Platz ausfüllt, an dem Du ihn einfügst. Mit der Option Benutzerdefiniert kannst Du eine maximale Containerbreite definieren.") }), c.default.createElement(b.default, { value: "default" }, (0, f.translate)("Gesamtbreite")), c.default.createElement(P.default, s({}, this.props, { value: "custom", label: (0, f.translate)("Benutzerdefiniert"), boxClass: "sui-border-frame" })))) } }]), t
        }(u.Component);
    t.default = x
}, function(e, t, n) {
    "use strict";
    ...
    var s = Object.assign || function(e) { for (var t = 1; t < arguments.length; t++) { var n = arguments[t]; for (var r in n) Object.prototype.hasOwnProperty.call(n, r) && (e[r] = n[r]) } return e },
        ...
        y = function(e) {
            function t(e) { return a(this, t), o(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this, e)) }
            return i(t, e), l(t, [{ key: "render", value: function() { return c.default.createElement(c.default.Fragment, null, c.default.createElement("div", { className: "sui-row", style: { marginBottom: "10px" } }, c.default.createElement(d.default, { cols: "3" }, c.default.createElement(m.default, s({}, this.props, { type: "number", minValue: "0", placeholder: "0", property: "quiz-padding-top", label: (0, f.translate)("Oben") }))), c.default.createElement(d.default, { cols: "3" }, c.default.createElement(m.default, s({}, this.props, { type: "number", minValue: "0", placeholder: "0", property: "quiz-padding-bottom", label: (0, f.translate)("Unten") }))), c.default.createElement(d.default, { cols: "3" }, c.default.createElement(m.default, s({}, this.props, { type: "number", minValue: "0", placeholder: "0", property: "quiz-padding-left", label: (0, f.translate)("Links") }))), c.default.createElement(d.default, { cols: "3" }, c.default.createElement(m.default, s({}, this.props, { type: "number", minValue: "0", placeholder: "0", property: "quiz-padding-right", label: (0, f.translate)("Rechts") })))), c.default.createElement("span", { className: "sui-description" }, (0, f.translate)("Stelle Deine benutzerdefinierte Polsterung in Pixel ein."))) } }]), t
        }(u.Component);
    t.default = y
}, function(e, t, n) {
    "use strict";
    ...
    var s = Object.assign || function(e) { for (var t = 1; t < arguments.length; t++) { var n = arguments[t]; for (var r in n) Object.prototype.hasOwnProperty.call(n, r) && (e[r] = n[r]) } return e },
        ...
        v = function(e) {
            function t(e) { return a(this, t), o(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this, e)) }
            return i(t, e), l(t, [{ key: "render", value: function() { return c.default.createElement(c.default.Fragment, null, c.default.createElement("div", { className: "sui-row", style: { marginBottom: "10px" } }, c.default.createElement(d.default, { cols: "4" }, c.default.createElement(m.default, s({}, this.props, { type: "number", minValue: "0", placeholder: "0", property: "quiz-border-radius", label: (0, f.translate)("Radius"), note: (0, f.translate)("in px") }))), c.default.createElement(d.default, { cols: "4" }, c.default.createElement(m.default, s({}, this.props, { type: "number", minValue: "0", placeholder: "0", property: "quiz-border-width", label: (0, f.translate)("Dicke"), note: (0, f.translate)("in px") }))), c.default.createElement(d.default, { cols: "4" }, c.default.createElement(b.default, s({}, this.props, { property: "quiz-border-style", defaultValue: "none", label: (0, f.translate)("Stil") }), c.default.createElement("option", { value: "solid" }, (0, f.translate)("Fest")), c.default.createElement("option", { value: "dashed" }, (0, f.translate)("Gestrichelt")), c.default.createElement("option", { value: "dotted" }, (0, f.translate)("Gepunktet")), c.default.createElement("option", { value: "none" }, (0, f.translate)("Keinen"))))), c.default.createElement("span", { className: "sui-description" }, (0, f.translate)("Hinweis: Lege die Farbe des Rahmens im Bereich Farbeneinstellungen oben fest."))) } }]), t
        }(u.Component);
    t.default = v
}, function(e, t, n) {
    "use strict";
    ...
    var s = Object.assign || function(e) { for (var t = 1; t < arguments.length; t++) { var n = arguments[t]; for (var r in n) Object.prototype.hasOwnProperty.call(n, r) && (e[r] = n[r]) } return e },
        ...
        h = function(e) {
            function t(e) { return a(this, t), o(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this, e)) }
            return i(t, e), l(t, [{ key: "render", value: function() { return c.default.createElement(d.default, s({}, this.props, { type: "number", minValue: "0", placeholder: "0", property: "quiz-custom-spacing", label: (0, f.translate)("Abstand"), note: (0, f.translate)("in pixels") })) } }]), t
        }(u.Component);
    t.default = h
}, function(e, t, n) {
    "use strict";
    ...
    var s = Object.assign || function(e) { for (var t = 1; t < arguments.length; t++) { var n = arguments[t]; for (var r in n) Object.prototype.hasOwnProperty.call(n, r) && (e[r] = n[r]) } return e },
        ...
        h = function(e) {
            function t(e) { return a(this, t), o(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this, e)) }
            return i(t, e), l(t, [{ key: "render", value: function() { return c.default.createElement(d.default, s({}, this.props, { type: "number", minValue: "0", placeholder: "0", defaultValue: "600", label: (0, f.translate)("Maximale Breite"), suffix: "px", property: "quiz-custom-size", inputClass: "sui-field-has-suffix", inputStyles: { maxWidth: "110px" } })) } }]), t
        }(u.Component);
    t.default = h
}, function(e, t, n) {
    "use strict";
    ...
    var s = Object.assign || function(e) { for (var t = 1; t < arguments.length; t++) { var n = arguments[t]; for (var r in n) Object.prototype.hasOwnProperty.call(n, r) && (e[r] = n[r]) } return e },
        ...
        h = function(e) {
            function t() { return a(this, t), o(this, (t.__proto__ || Object.getPrototypeOf(t)).apply(this, arguments)) }
            return i(t, e), l(t, [{ key: "render", value: function() { return c.default.createElement("div", { className: "sui-box-settings-row" }, c.default.createElement("div", { className: "sui-box-settings-col-1" }, c.default.createElement("span", { className: "sui-settings-label" }, (0, f.translate)("Rendern")), c.default.createElement("span", { className: "sui-description" }, (0, f.translate)("Wähle aus, wie Dein Quiz für Benutzer gerendert werden soll."))), c.default.createElement("div", { className: "sui-box-settings-col-2" }, c.default.createElement(d.default, s({}, this.props, { property: "use_ajax_load", label: (0, f.translate)("Lade das Quiz mit AJAX"), description: (0, f.translate)("Durch Aktivieren dieser Funktion wird das Quiz nach dem Laden der Seite über AJAX geladen, wodurch die Ladezeit Deiner Seite effektiv beschleunigt wird. Diese Methode kann (in den meisten Fällen) auch Probleme beim Zwischenspeichern von Seiten in Deinem Quiz vermeiden.") })), c.default.createElement(d.default, s({}, this.props, { property: "use_donotcachepage", label: (0, f.translate)("Verhindere das Zwischenspeichern von Seiten auf Testseiten"), description: (0, f.translate)("Plugins zum Zwischenspeichern von Seiten stellen eine statische HTML-Version der Seite bereit, die Probleme bei Deinen dynamischen Tests verursachen kann. Wenn Du dies aktivierst, verwenden wir die Konstante {{strong}}DONOTCACHEPAGE{{/strong}}, um zu verhindern, dass Seiten mit diesem Quiz zwischengespeichert werden.", { components: { strong: c.default.createElement("strong", null) } }) })))) } }]), t
        }(u.Component);
    t.default = h
}, function(e, t, n) {
    "use strict";
        ...
        f = function(e) {
            ...
            return i(t, e), s(t, [{ key: "closeMenu", value: function() { jQuery(".sui-dropdown").removeClass("open") } }, { key: "getNotificationsWithoutCurrent", value: function(e) { var t = this; return e.filter(function(e) { return e.slug !== t.props.notification.slug }) } }, { key: "deleteNotification", value: function() { this.closeMenu(), this.props.actions.modalActions.showModal({ open: !0, notification: this.props.notification, closeModal: this.closeDeleteField, trashField: this.trashNotification }, "deleteNotification") } }, { key: "closeDeleteField", value: function() { this.props.actions.modalActions.showModal({ open: !1, notification: this.props.notification, closeModal: this.closeDeleteField, trashField: this.trashNotification }, "deleteNotification") } }, {
                ...
                value: function() {
                    ...
                    var r = "hide" === this.props.notification.condition_action ? (0, c.translate)("Ausblenden") : (0, c.translate)("Anzeigen");
                        ...
                        if (!_.isUndefined(a)) {
                            ...
                            if (!(_.isUndefined(o) && _.isUndefined(i) || _.isUndefined(o[0]) && _.isUndefined(i[0]))) {
                                ...
                                var p = f,
                                    ...
                                    y = "";
                                return m - 1 > 0 && (y = "+ " + (m - 1) + " " + (0, c.translate)("mehr Bedingung(en)")), u.default.createElement("span", { className: "fui-conditions sui-tooltip sui-tooltip-left sui-tooltip-top-right-mobile", "data-tooltip": r + " " + (0, c.translate)("wenn") + " " + p + " " + d + " " + h + " " + y, "aria-hidden": "true" }, u.default.createElement("i", { className: "sui-icon-link sui-sm" }))
                            }
                        }
                    }
                }
                    ...
                    if (_.isUndefined(this.props.notification["email-recipients"]) || "routing" !== this.props.notification["email-recipients"]) {
                        ...
                        if (!_.isUndefined(this.props.notification.recipients) && !_.isEmpty(this.props.notification.recipients)) {
                            var n = this.props.notification.recipients.split(","),
                                r = n.length;
                            t = r > 2 ? n[0] + ", " + n[1] + " + " + (r - 2) + " " + (0, c.translate)("mehr Empfänger") : this.props.notification.recipients, e = t
                        }
                    } else e = (0, c.translate)("E-Mail-Routing ist aktiviert");
                    var a = this.conditionMarkup();
                    return u.default.createElement("div", { className: "sui-builder-field sui-react sui-can_open" }, !_.isUndefined(this.props.notification.conditions) && this.props.notification.conditions.length > 0 && u.default.createElement(u.default.Fragment, null, a), u.default.createElement("div", { className: "sui-field-info fui-notifications-info", onClick: this.editModal }, u.default.createElement("div", { className: "sui-builder-field-label fui-notifications-label" }, u.default.createElement("i", { className: "sui-icon-mail", "aria-hidden": "true" }), u.default.createElement("span", null, this.props.notification.label)), u.default.createElement("div", { className: "sui-builder-field-label fui-notifications-recipient" }, u.default.createElement("span", null, e))), u.default.createElement("div", { className: "sui-field-actions" }, u.default.createElement("div", { className: "sui-dropdown" }, u.default.createElement("button", { className: "sui-button-icon sui-dropdown-anchor" }, u.default.createElement("i", { className: "sui-icon-widget-settings-config", "aria-hidden": "true" }), u.default.createElement("span", { className: "sui-screen-reader-text" }, (0, c.translate)("Feldeinstellungen öffnen"))), u.default.createElement("ul", null, u.default.createElement("li", null, u.default.createElement("button", { onClick: this.editModal }, u.default.createElement("i", { className: "sui-icon-pencil", "aria-hidden": "true" }), (0, c.translate)("Bearbeiten"))), u.default.createElement("li", null, u.default.createElement("button", { onClick: this.duplicateNotification }, u.default.createElement("i", { className: "sui-icon-copy", "aria-hidden": "true" }), (0, c.translate)("Klonen"))), u.default.createElement("li", null, u.default.createElement("button", { className: "sui-option-red", onClick: this.deleteNotification }, u.default.createElement("i", { className: "sui-icon-trash", "aria-hidden": "true" }), (0, c.translate)("Löschen")))))))
                }
            }]), t
        }(l.Component);
    t.default = f
    ...
    var s = function() {
        ...
        U = function(e) {
            ...
            }, { key: "handleBeforeunload", value: function(e) { if (window.powerformChanges.length > 0 || !0 === window.powerformChanges.settings) return e.preventDefault(), e.returnValue = (0, f.translate)("Du hast nicht gespeicherte Änderungen, möchtest Du diese Seite wirklich verlassen?"), (0, f.translate)("Du hast nicht gespeicherte Änderungen, möchtest Du diese Seite wirklich verlassen?") } }, { key: "render", value: function() { return u.default.createElement("div", null, u.default.createElement(d.default, null), u.default.createElement("div", { className: "sui-row-with-sidenav" }, u.default.createElement(b.default, this.props), u.default.createElement("div", null, u.default.createElement("div", { id: "powerform-builder-status", className: "sui-box sui-box-sticky", ref: "StickyHeader" }, u.default.createElement(g.default, null)), u.default.createElement(c.Route, { exact: !0, path: "/", render: function() { return u.default.createElement(c.Redirect, { to: "/intro" }) } }), u.default.createElement(c.Route, { path: "/intro", component: E.default }), u.default.createElement(c.Route, { path: "/personalities", component: O.default }), u.default.createElement(c.Route, { path: "/questions", component: P.default }), u.default.createElement(c.Route, { path: "/leads", component: N.default }), u.default.createElement(c.Route, { path: "/appearance", component: C.default }), u.default.createElement(c.Route, { path: "/behaviour", component: M.default }), u.default.createElement(c.Route, { path: "/notifications", component: A.default }), u.default.createElement(c.Route, { path: "/integrations", component: R.default }), u.default.createElement(c.Route, { path: "/settings", component: q.default }))), u.default.createElement(m.default, this.props)) } }]), t
        }(l.Component);
    t.default = U
}, function(e, t, n) {
    "use strict";
    ...
    var s = function() {
        ...
        h = function(e) {
            function t(e) { return a(this, t), o(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this, e)) }
            return i(t, e), s(t, [{ key: "render", value: function() { return u.default.createElement(u.default.Fragment, null, u.default.createElement("ul", { className: "sui-vertical-tabs sui-sidenav-sticky sui-sidenav-hide-md fui-sidenav" }, u.default.createElement("li", { className: "sui-vertical-tab" }, u.default.createElement(c.NavLink, { to: "/intro", activeClassName: "current" }, (0, f.translate)("Einführung"))), u.default.createElement("li", { className: "sui-vertical-tab" }, u.default.createElement(c.NavLink, { to: "/personalities", activeClassName: "current" }, (0, f.translate)("Persönlichkeiten"))), u.default.createElement("li", { className: "sui-vertical-tab" }, u.default.createElement(c.NavLink, { to: "/questions", activeClassName: "current" }, (0, f.translate)("Fragen"))), this.props.hasLead && u.default.createElement("li", { className: "sui-vertical-tab" }, u.default.createElement(c.NavLink, { to: "/leads", activeClassName: "current" }, (0, f.translate)("Leads"))), u.default.createElement("li", { className: "sui-vertical-tab" }, u.default.createElement(c.NavLink, { to: "/appearance", activeClassName: "current" }, (0, f.translate)("Aussehen"))), u.default.createElement("li", { className: "sui-vertical-tab" }, u.default.createElement(c.NavLink, { to: "/behaviour", activeClassName: "current" }, (0, f.translate)("Verhalten"))), u.default.createElement("li", { className: "sui-vertical-tab" }, u.default.createElement(c.NavLink, { to: "/notifications", activeClassName: "current" }, (0, f.translate)("E-Mail-Benachrichtigungen"))), u.default.createElement("li", { className: "sui-vertical-tab" }, u.default.createElement(c.NavLink, { to: "/integrations", activeClassName: "current" }, (0, f.translate)("Integrationen"))), u.default.createElement("li", { className: "sui-vertical-tab" }, u.default.createElement(c.NavLink, { to: "/settings", activeClassName: "current" }, (0, f.translate)("Einstellungen")))), u.default.createElement(d.default, this.props, u.default.createElement("option", { value: "" }, (0, f.translate)("Einführung")), u.default.createElement("option", { value: "personalities" }, (0, f.translate)("Persönlichkeiten")), u.default.createElement("option", { value: "questions" }, (0, f.translate)("Fragen")), "true" === this.props.hasLead && u.default.createElement("option", { value: "leads" }, (0, f.translate)("Leads")), u.default.createElement("option", { value: "appearance" }, (0, f.translate)("Aussehen")), u.default.createElement("option", { value: "behaviour" }, (0, f.translate)("Verhalten")), u.default.createElement("option", { value: "notifications" }, (0, f.translate)("E-Mail-Benachrichtigungen")), u.default.createElement("option", { value: "integrations" }, (0, f.translate)("Integrationen")), u.default.createElement("option", { value: "settings" }, (0, f.translate)("Einstellungen")))) } }]), t
        }(l.Component);
    t.default = h
}, function(e, t, n) {
    "use strict";
        ...
        d = function(e) {
            ...
            return i(t, e), s(t, [{ key: "componentDidMount", value: function() { jQuery("html, body").animate({ scrollTop: 0 }, "fast") } }, {
                ...
                value: function() {
                    var e = this,
                        t = function(t) { e.props.history.push("/" + t) };
                    return u.default.createElement("div", { id: "powerform-form-fields", className: "sui-box" }, u.default.createElement("div", { className: "sui-box-header" }, u.default.createElement("h2", { className: "sui-box-title" }, (0, c.translate)("Persönlichkeiten"))), u.default.createElement("div", { className: "sui-box-body" }, u.default.createElement("p", { className: "sui-description" }, (0, c.translate)("Fügen wir die verschiedenen Persönlichkeiten hinzu. Jede der folgenden Persönlichkeiten ist ein mögliches Ergebnis Deines Tests. Im Falle eines Unentschieden wird die Persönlichkeit gemäß der unten angegebenen Reihenfolge ausgewählt."))), u.default.createElement("div", { className: "sui-box-body" }, u.default.createElement(p.default, this.props)), u.default.createElement("div", { className: "sui-box-body", style: { paddingTop: "10px" } }, u.default.createElement("p", { className: "sui-description" }, (0, c.translate)("Ordne die Persönlichkeiten neu an, um die Prioritätsreihenfolge festzulegen."))), u.default.createElement("div", { className: "sui-box-footer" }, u.default.createElement("button", { className: "sui-button", onClick: function() { return t("") } }, u.default.createElement("i", { className: "sui-icon-arrow-left", "aria-hidden": "true" }), (0, c.translate)("Einführung")), u.default.createElement("div", { className: "sui-actions-right" }, u.default.createElement("button", { className: "sui-button sui-button-icon-right", onClick: function() { return t("questions") } }, (0, c.translate)("Fragen"), u.default.createElement("i", { className: "sui-icon-arrow-right", "aria-hidden": "true" })))))
                }
            }]), t
        }(l.Component);
    t.default = d
    ...
    var s = function() {
        ...
        f = function(e) {
            ...
            }, { key: "render", value: function() { var e = ""; return _.isUndefined(this.props.result.image) || _.isEmpty(this.props.result.image) || (e = "url(" + this.props.result.image + ")"), u.default.createElement("div", { className: "sui-builder-field sui-react sui-can_move" }, u.default.createElement("div", { className: "sui-field-info", onClick: this.editModal }, u.default.createElement("i", { className: "sui-icon-drag", "aria-hidden": "true" }), u.default.createElement("div", { className: "sui-builder-field-label" }, u.default.createElement("div", { className: "sui-builder-field-image", "aria-hidden": "true" }, u.default.createElement("span", { style: { backgroundImage: e } })), u.default.createElement("span", null, this.props.result.title))), u.default.createElement("div", { className: "sui-field-actions" }, u.default.createElement("div", { className: "sui-dropdown" }, u.default.createElement("button", { className: "sui-button-icon sui-dropdown-anchor" }, u.default.createElement("i", { className: "sui-icon-widget-settings-config", "aria-hidden": "true" }), u.default.createElement("span", { className: "sui-screen-reader-text" }, (0, c.translate)("Feldeinstellungen öffnen"))), u.default.createElement("ul", null, u.default.createElement("li", null, u.default.createElement("button", { onClick: this.editModal }, u.default.createElement("i", { className: "sui-icon-pencil", "aria-hidden": "true" }), (0, c.translate)("Bearbeiten"))), u.default.createElement("li", null, u.default.createElement("button", { onClick: this.duplicateResult }, u.default.createElement("i", { className: "sui-icon-copy", "aria-hidden": "true" }), (0, c.translate)("Klonen"))), u.default.createElement("li", null, u.default.createElement("button", { className: "sui-option-red", onClick: this.deleteResult }, u.default.createElement("i", { className: "sui-icon-trash", "aria-hidden": "true" }), (0, c.translate)("Löschen"))))))) } }]), t
        }(l.Component);
    t.default = f
}, function(e, t, n) {
    "use strict";
        ...
        k = function(e) {
            ...
            return i(t, e), s(t, [{ key: "componentDidMount", value: function() { this.loadFonts(), jQuery("html, body").animate({ scrollTop: 0 }, "fast") } }, { key: "componentDidUpdate", value: function() { this.loadFonts() } }, {
                ...
                value: function() {
                    var e = this,
                        t = function(t) { e.props.history.push("/" + t) };
                    return u.default.createElement("div", { id: "powerform-form-appearance", className: "sui-box" }, u.default.createElement("div", { className: "sui-box-header" }, u.default.createElement("h2", { className: "sui-box-title" }, (0, c.translate)("Aussehen"))), u.default.createElement("div", { className: "sui-box-body" }, u.default.createElement(y.default, this.props), "none" !== this.props.quizDesign && u.default.createElement(u.default.Fragment, null, u.default.createElement(v.default, this.props), u.default.createElement(E.default, this.props), u.default.createElement(O.default, this.props), u.default.createElement(P.default, this.props)), u.default.createElement(N.default, this.props)), u.default.createElement("div", { className: "sui-box-footer" }, this.props.hasLead && u.default.createElement("button", { className: "sui-button", onClick: function() { return t("leads") } }, u.default.createElement("i", { className: "sui-icon-arrow-left", "aria-hidden": "true" }), (0, c.translate)("Leads")), !this.props.hasLead && u.default.createElement("button", { className: "sui-button", onClick: function() { return t("questions") } }, u.default.createElement("i", { className: "sui-icon-arrow-left", "aria-hidden": "true" }), (0, c.translate)("Fragen")), u.default.createElement("div", { className: "sui-actions-right" }, u.default.createElement("button", { className: "sui-button sui-button-icon-right", onClick: function() { return t("behaviour") } }, (0, c.translate)("Verhalten"), u.default.createElement("i", { className: "sui-icon-arrow-right", "aria-hidden": "true" })))))
                }
            }]), t
        }(l.Component);
    t.default = k
    ...
    var s = Object.assign || function(e) { for (var t = 1; t < arguments.length; t++) { var n = arguments[t]; for (var r in n) Object.prototype.hasOwnProperty.call(n, r) && (e[r] = n[r]) } return e },
        ...
        v = function(e) {
            function t(e) { return a(this, t), o(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this, e)) }
            return i(t, e), l(t, [{ key: "render", value: function() { return c.default.createElement(c.default.Fragment, null, this.props.settings.hasLeads && c.default.createElement(m.default, { default: "default", type: "tabs", extraClass: "sui-tabs-flushed" }, c.default.createElement(b.default, { value: "default", label: (0, f.translate)("Standard") }, c.default.createElement(d.default, s({}, this.props, { label: (0, f.translate)("Hauptcontainer"), property: "nowrong-container-color", defaultValue: "rgba(0,0,0,0)", isAlpha: !0 })), c.default.createElement(d.default, s({}, this.props, { label: (0, f.translate)("Titelfarbe"), property: "nowrong-title-color", defaultValue: "#000000" })), c.default.createElement(d.default, s({}, this.props, { label: (0, f.translate)("Beschreibung Farbe"), property: "nowrong-description-color", defaultValue: "#000000" })), c.default.createElement(d.default, s({}, this.props, { label: (0, f.translate)("Frage Farbe"), property: "nowrong-question-color", defaultValue: "#000000" })), c.default.createElement(d.default, s({}, this.props, { label: (0, f.translate)("Farbe des Testergebnisses"), property: "nowrong-summary-color", defaultValue: "#000000" })), c.default.createElement(d.default, s({}, this.props, { label: (0, f.translate)("Formularschaltfläche überspringen"), property: "nowrong-skip-default-color", defaultValue: "#888888" }))), c.default.createElement(b.default, { value: "hover", label: (0, f.translate)("Hover") }, c.default.createElement(d.default, s({}, this.props, { label: (0, f.translate)("Formularschaltfläche überspringen"), property: "nowrong-skip-hover-color", defaultValue: "#333333" }))), c.default.createElement(b.default, { value: "focus", label: (0, f.translate)("Focus") }, c.default.createElement(d.default, s({}, this.props, { label: (0, f.translate)("Formularschaltfläche überspringen"), property: "nowrong-skip-focus-color", defaultValue: "#333333" })))), !this.props.settings.hasLeads && c.default.createElement(c.default.Fragment, null, c.default.createElement(d.default, s({}, this.props, { label: (0, f.translate)("Hauptcontainer"), property: "nowrong-container-color", defaultValue: "rgba(0,0,0,0)", isAlpha: !0 })), c.default.createElement(d.default, s({}, this.props, { label: (0, f.translate)("Titelfarbe"), property: "nowrong-title-color", defaultValue: "#333333" })), c.default.createElement(d.default, s({}, this.props, { label: (0, f.translate)("Beschreibung Farbe"), property: "nowrong-description-color", defaultValue: "#8C8C8C" })), c.default.createElement(d.default, s({}, this.props, { label: (0, f.translate)("Frage Farbe"), property: "nowrong-question-color", defaultValue: "#333333" })))) } }]), t
        }(u.Component);
    t.default = v
}, function(e, t, n) {
    "use strict";
    ...
    var s = Object.assign || function(e) { for (var t = 1; t < arguments.length; t++) { var n = arguments[t]; for (var r in n) Object.prototype.hasOwnProperty.call(n, r) && (e[r] = n[r]) } return e },
        ...
        v = function(e) {
            function t(e) { return a(this, t), o(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this, e)) }
            return i(t, e), l(t, [{ key: "render", value: function() { return c.default.createElement(d.default, { default: "default", type: "tabs", extraClass: "sui-tabs-flushed" }, c.default.createElement(m.default, { value: "default", label: (0, f.translate)("Standard") }, "flat" !== this.props.quizDesign && "material" !== this.props.quizDesign && c.default.createElement(b.default, s({}, this.props, { label: (0, f.translate)("Rahmenfarbe"), property: "nowrong-answer-border-static", defaultValue: "#EBEDEB", isAlpha: !0 })), c.default.createElement(b.default, s({}, this.props, { label: (0, f.translate)("Hintergrundfarbe"), property: "nowrong-answer-background-static", defaultValue: "#FAFAFA", isAlpha: !0 }))), c.default.createElement(m.default, { value: "hover", label: (0, f.translate)("Hover") }, "flat" !== this.props.quizDesign && "material" !== this.props.quizDesign && c.default.createElement(b.default, s({}, this.props, { label: (0, f.translate)("Rahmenfarbe"), property: "nowrong-answer-border-hover", defaultValue: "#17A8E3", isAlpha: !0 })), c.default.createElement(b.default, s({}, this.props, { label: (0, f.translate)("Hintergrundfarbe"), property: "nowrong-answer-background-hover", defaultValue: "#F3FBFE", isAlpha: !0 }))), c.default.createElement(m.default, { value: "active", label: (0, f.translate)("Aktiv") }, "flat" !== this.props.quizDesign && "material" !== this.props.quizDesign && c.default.createElement(b.default, s({}, this.props, { label: (0, f.translate)("Rahmenfarbe"), property: "nowrong-answer-border-active", defaultValue: "#17A8E3", isAlpha: !0 })), c.default.createElement(b.default, s({}, this.props, { label: (0, f.translate)("Hintergrundfarbe"), property: "nowrong-answer-background-active", defaultValue: "#F3FBFE", isAlpha: !0 })))) } }]), t
        }(u.Component);
    t.default = v
}, function(e, t, n) {
    "use strict";
    ...
    var s = Object.assign || function(e) { for (var t = 1; t < arguments.length; t++) { var n = arguments[t]; for (var r in n) Object.prototype.hasOwnProperty.call(n, r) && (e[r] = n[r]) } return e },
        ...
        v = function(e) {
            function t(e) { return a(this, t), o(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this, e)) }
            return i(t, e), l(t, [{ key: "render", value: function() { return c.default.createElement(d.default, { default: "default", type: "tabs", extraClass: "sui-tabs-flushed" }, c.default.createElement(m.default, { value: "default", label: (0, f.translate)("Standard") }, "flat" !== this.props.quizDesign && c.default.createElement(b.default, s({}, this.props, { label: (0, f.translate)("Rahmenfarbe"), property: "nowrong-answer-chkbo-static", defaultValue: "#BFBFBF", isAlpha: !0 })), "material" !== this.props.quizDesign && c.default.createElement(b.default, s({}, this.props, { label: (0, f.translate)("Hintergrundfarbe"), property: "nowrong-answer-chkbg-static", defaultValue: "#FFFFFF", isAlpha: !0 }))), c.default.createElement(m.default, { value: "active", label: (0, f.translate)("Ausgewählt") }, "flat" !== this.props.quizDesign && c.default.createElement(b.default, s({}, this.props, { label: (0, f.translate)("Rahmenfarbe"), property: "nowrong-answer-chkbo-active", defaultValue: "#17A8E3", isAlpha: !0 })), "material" !== this.props.quizDesign && c.default.createElement(b.default, s({}, this.props, { label: (0, f.translate)("Hintergrundfarbe"), property: "nowrong-answer-chkbg-active", defaultValue: "#17A8E3", isAlpha: !0 })), c.default.createElement(b.default, s({}, this.props, { label: (0, f.translate)("Symbolfarbe"), property: "nowrong-answer-chck-icon", defaultValue: "material" !== this.props.quizDesign ? "#FFFFFF" : "#17A8E3", isAlpha: !0 })))) } }]), t
        }(u.Component);
    t.default = v
}, function(e, t, n) {
    "use strict";
    ...
    var s = Object.assign || function(e) { for (var t = 1; t < arguments.length; t++) { var n = arguments[t]; for (var r in n) Object.prototype.hasOwnProperty.call(n, r) && (e[r] = n[r]) } return e },
        ...
        v = function(e) {
            function t(e) { return a(this, t), o(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this, e)) }
            return i(t, e), l(t, [{ key: "render", value: function() { return c.default.createElement(d.default, { default: "default", type: "tabs", extraClass: "sui-tabs-flushed" }, c.default.createElement(m.default, { value: "default", label: (0, f.translate)("Standard") }, c.default.createElement(b.default, s({}, this.props, { label: (0, f.translate)("Beantworten Textfarbe"), property: "nowrong-answer-color-static", defaultValue: "#888888" }))), c.default.createElement(m.default, { value: "active", label: (0, f.translate)("Aktiv") }, c.default.createElement(b.default, s({}, this.props, { label: (0, f.translate)("Beantworten Textfarbe"), property: "nowrong-answer-color-active", defaultValue: "#333333" })))) } }]), t
        }(u.Component);
    t.default = v
}, function(e, t, n) {
    "use strict";
    ...
    var s = Object.assign || function(e) { for (var t = 1; t < arguments.length; t++) { var n = arguments[t]; for (var r in n) Object.prototype.hasOwnProperty.call(n, r) && (e[r] = n[r]) } return e },
        ...
        v = function(e) {
            function t(e) { return a(this, t), o(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this, e)) }
            return i(t, e), l(t, [{ key: "render", value: function() { return c.default.createElement(d.default, { default: "default", type: "tabs", extraClass: "sui-tabs-flushed" }, c.default.createElement(m.default, { value: "default", label: (0, f.translate)("Standard") }, "material" !== this.props.quizDesign && c.default.createElement(b.default, s({}, this.props, { label: (0, f.translate)("Hintergrundfarbe"), property: "nowrong-result-retake-background-static", defaultValue: "#17A8E3", isAlpha: !0 })), c.default.createElement(b.default, s({}, this.props, { label: (0, f.translate)("Beschriftungsfarbe"), property: "nowrong-result-retake-color-static", defaultValue: "material" === this.props.quizDesign ? "#17A8E3" : "#FFFFFF", isAlpha: !0 }))), c.default.createElement(m.default, { value: "hover", label: (0, f.translate)("Hover") }, "material" !== this.props.quizDesign && c.default.createElement(b.default, s({}, this.props, { label: (0, f.translate)("Hintergrundfarbe"), property: "nowrong-result-retake-background-hover", defaultValue: "#17A8E3", isAlpha: !0 })), c.default.createElement(b.default, s({}, this.props, { label: (0, f.translate)("Beschriftungsfarbe"), property: "nowrong-result-retake-color-hover", defaultValue: "material" === this.props.quizDesign ? "#17A8E3" : "#FFFFFF", isAlpha: !0 }))), c.default.createElement(m.default, { value: "active", label: (0, f.translate)("Aktiv") }, "material" !== this.props.quizDesign && c.default.createElement(b.default, s({}, this.props, { label: (0, f.translate)("Hintergrundfarbe"), property: "nowrong-result-retake-background-active", defaultValue: "#17A8E3", isAlpha: !0 })), c.default.createElement(b.default, s({}, this.props, { label: (0, f.translate)("Beschriftungsfarbe"), property: "nowrong-result-retake-color-active", defaultValue: "material" === this.props.quizDesign ? "#17A8E3" : "#FFFFFF", isAlpha: !0 })))) } }]), t
        }(u.Component);
    t.default = v
}, function(e, t, n) {
    "use strict";
    ...
    var s = Object.assign || function(e) { for (var t = 1; t < arguments.length; t++) { var n = arguments[t]; for (var r in n) Object.prototype.hasOwnProperty.call(n, r) && (e[r] = n[r]) } return e },
        ...
        _ = function(e) {
            function t() { return a(this, t), o(this, (t.__proto__ || Object.getPrototypeOf(t)).apply(this, arguments)) }
            return i(t, e), l(t, [{ key: "render", value: function() { return c.default.createElement(d.default, { label: (0, f.translate)("Schriftarten"), description: (0, f.translate)("Standardmäßig erbt dieses Quiz die von Deinem Theme verwendeten Schriftarten. Du kannst diese Schriftarten mit benutzerdefinierten Schriftarten aus Google Fonts überschreiben.") }, c.default.createElement(m.default, s({}, this.props, { property: "nowrong-toggle-typography", default: "" }), c.default.createElement(b.default, { value: "", boxClass: "" }, (0, f.translate)("Verwende Themenschriftarten")), c.default.createElement(g.default, s({}, this.props, { value: "true", boxClass: "" }), (0, f.translate)("Benutzerdefiniert")))) } }]), t
        }(u.Component);
    t.default = _
}, function(e, t, n) {
    "use strict";
