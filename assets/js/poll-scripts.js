            ...
            return a(t, e), s(t, [{ key: "updateValue", value: function(e) { "function" == typeof this.props.updateProperty ? this.props.updateProperty(this.props.property, e) : this.props.actions.settingsActions.updateSetting(this.props.property, e) } }, { key: "isValid", value: function(e) { return this.props.isRequired ? this.props.isRequired && !_.isEmpty(e) : !!_.isUndefined(this.props.isPositive) || (_.isEmpty(e) || e >= 0) } }, {
                ...
                value: function() {
                    ...
                    var f = u.default.createElement("input", i({ type: n, placeholder: this.props.placeholder, value: t || "", id: "powerform-field-" + l, className: s }, this.props.notWritable && { readonly: "" }, this.props.minValue && { min: this.props.minValue }, this.props.maxValue && { max: this.props.maxValue }, this.props.maxLength && { maxlength: this.props.maxLength }, this.props.inputStyles && { style: this.props.inputStyles }, { disabled: !!this.props.disabled, onChange: function(t) { e.updateValue(t.target.value) } })),
                        d = u.default.createElement("div", { className: a + " " + o }, p, this.props.canTrash ? u.default.createElement("div", { className: "sui-with-button sui-with-button-icon" }, f, u.default.createElement("button", { className: "sui-button-icon sui-tooltip sui-tooltip-top-right", "data-tooltip": (0, c.translate)("Löschen") }, u.default.createElement("i", { className: "sui-icon-trash", "aria-hidden": "true" }))) : f, this.props.suffix && u.default.createElement("span", { className: "sui-field-suffix" }, this.props.suffix), this.props.isRequired && !this.isValid(t) && u.default.createElement("span", { className: "sui-error-message" }, r), !_.isUndefined(this.props.isPositive) && !this.isValid(t) && u.default.createElement("span", { className: "sui-error-message" }, (0, c.translate)("Bitte gib eine gültige Nummer ein.")), this.props.description && u.default.createElement("span", { className: "sui-description" }, this.props.description));
        ...
        c = function(e) {
            ...
            return a(t, e), i(t, [{
                ...
                value: function() {
                    ...
                    return l.default.createElement(l.default.Fragment, null, n && l.default.createElement(l.default.Fragment, null, l.default.createElement("li", { className: "psource-dropdown--option" }, l.default.createElement("strong", null, (0, u.translate)("Benötigte Felder"))), l.default.createElement(l.default.Fragment, null, n)), !_.isUndefined(o[0]) && o && l.default.createElement(l.default.Fragment, null, l.default.createElement("li", { className: "psource-dropdown--option" }, l.default.createElement("strong", null, (0, u.translate)("Optionale Felder"))), l.default.createElement(l.default.Fragment, null, o)))
                }
            }, {
                key: "getMiscData",
                value: function() {
                ...
                value: function() {
                    ...
                    var t = this.props.disableMiscData ? "" : this.getMiscData(),
                        ...
                        o = this.props.mainOptions ? this.props.mainOptions : { form_name: (0, u.translate)("Formularname") };
                    return l.default.createElement("ul", { className: this.state.editorOptionsOpen ? "sui-active" : "" }, this.props.enableAllFormFields && l.default.createElement("li", { className: "psource-dropdown--option" }, l.default.createElement("a", { className: "psource-insert-content", onClick: this.insertContent.bind(this, "all_fields") }, (0, u.translate)("Alle Formularfelder"))), this.props.enableAllNonFormFields && l.default.createElement("li", { className: "psource-dropdown--option" }, l.default.createElement("a", { className: "psource-insert-content", onClick: this.insertContent.bind(this, "all_non_empty_fields") }, (0, u.translate)("Alle nicht leeren Felder"))), r, l.default.createElement(l.default.Fragment, null, this.props.mainOptionsLabel && l.default.createElement("li", { className: "psource-dropdown--option" }, l.default.createElement("strong", null, this.props.mainOptionsLabel)), _.map(o, function(t, n) { return l.default.createElement("li", { className: "psource-dropdown--option", key: n }, l.default.createElement("a", { className: "psource-insert-content", onClick: e.insertContent.bind(e, n) }, t)) })), t, n)
                }
    ...
    */
    ...
    var s = function() {
        ...
        d = function(e) {
            ...
            return i(t, e), s(t, [{ key: "copyToClipboard", value: function() { this.input.select(), document.execCommand("copy"), new f.default({ type: "success", text: (0, c.translate)("Der Shortcode wurde erfolgreich kopiert."), time: 4e3 }).open() } }, {
                key: "render",
                value: function() {
                    var e = this,
                ...
                value: function(e, t, n) {
                    ...
                    n && (this.$el.find(".sui-box-body").html('<p class="fui-loading-dialog" aria-label="Loading content"><i class="sui-icon-loader sui-loading" aria-hidden="true"></i></p>'), this.$el.find(".sui-box-footer").html(""), this.$el.find(".integration-header").html("")), this.$el.find(".sui-button:not(.disable-loader)").addClass("sui-button-onload"), this.ajax = jQuery.post({ url: powerformData.ajaxUrl, type: "post", data: e }).done(function(e) {
                        if (e && e.success) {
                            ...
                            n.is_poll && setTimeout(r.request(o.data, o.close, o.loader), 5e3), setTimeout(function() { SUI.suiAccordion(jQuery(".sui-accordion")), SUI.suiTabs(jQuery(".sui-tabs")), jQuery(".sui-2-6-0 select").not(".sui-select").not(".powerform-select").not(".powerform-time").not(".fui-multi-select").each(function() { SUI.suiSelect(jQuery(this)) }), jQuery(".sui-2-6-0 select.sui-select").not(".fui-multi-select").not(".custom-select2").each(function() { jQuery(this).SUIselect2({ dropdownCssClass: "sui-select-dropdown" }) }), SUI.loadCircleScore(jQuery(".sui-circle-score")), SUI.showHidePassword() }, 10);
            ...
            return a(t, e), s(t, [{
                ...
                value: function() {
                    var e = this,
                        ...
                        r = void 0,
                        o = void 0;
                    this.props.label && (r = u.default.createElement("label", { htmlFor: "powerform-field-" + this.props.property, className: "sui-label" }, this.props.label, this.props.note && u.default.createElement("span", { className: "sui-label-note" }, this.props.note))), this.props.canTrash && (o = u.default.createElement("button", { className: "sui-button-icon" }, u.default.createElement("i", { className: "sui-icon-trash", "aria-hidden": "true" }), u.default.createElement("span", { className: "sui-screen-reader-text" }, (0, c.translate)("Entferne diesen Datumsbereich")))), this.props.canAdd && (o = u.default.createElement("button", { className: "sui-button-icon" }, u.default.createElement("i", { className: "sui-icon-plus", "aria-hidden": "true" }), u.default.createElement("span", { className: "sui-screen-reader-text" }, (0, c.translate)("Ausgewähltes Datum hinzufügen"))));
    ...
    var s = function() {
        ...
        M = function(e) {
            ...
            }, { key: "handleBeforeunload", value: function(e) { if (window.powerformChanges.length > 0 || !0 === window.powerformChanges.settings) return e.preventDefault(), e.returnValue = (0, f.translate)("Du hast nicht gespeicherte Änderungen, möchtest Du diese Seite wirklich verlassen?"), (0, f.translate)("Du hast nicht gespeicherte Änderungen, möchtest Du diese Seite wirklich verlassen?") } }, { key: "render", value: function() { return u.default.createElement("div", null, u.default.createElement(h.default, null), u.default.createElement("div", { className: "sui-row-with-sidenav" }, u.default.createElement(_.default, this.props), u.default.createElement("div", null, u.default.createElement("div", { id: "powerform-builder-status", className: "sui-box sui-box-sticky", ref: "StickyHeader" }, u.default.createElement(v.default, null)), u.default.createElement(p.Route, { exact: !0, path: "/", render: function() { return u.default.createElement(p.Redirect, { to: "/builder" }) } }), u.default.createElement(p.Route, { path: "/builder", component: E.default }), u.default.createElement(p.Route, { path: "/appearance", component: j.default }), u.default.createElement(p.Route, { path: "/behaviour", component: P.default }), u.default.createElement(p.Route, { path: "/notifications", component: N.default }), u.default.createElement(p.Route, { path: "/integrations", component: S.default }), u.default.createElement(p.Route, { path: "/settings", component: A.default }))), u.default.createElement(y.default, this.props)) } }]), t
        }(l.Component);
    t.default = M
}, function(e, t, n) {
    "use strict";
    ...
    function o(e) { return i.default.createElement("div", { className: "sui-header fui-header-with-settings" }, i.default.createElement("div", { className: "fui-header-title" }, i.default.createElement("h1", { className: "sui-header-title" }, (0, s.translate)("Umfrage bearbeiten")), i.default.createElement("div", { className: "sui-actions-right" }, i.default.createElement(u.default, e))), i.default.createElement("div", { className: "fui-header-settings" }, i.default.createElement("div", { className: "sui-actions-left" }, i.default.createElement(p.default, e)), i.default.createElement("div", { className: "sui-actions-right" }, i.default.createElement(u.default, e)))) }
    Object.defineProperty(t, "__esModule", { value: !0 }), t.default = o;
    var a = n(0),
        i = r(a),
        s = n(1),
    ...
    function r(e) { return powerformData.showDocLink ? a.default.createElement("a", { href: "https://n3rds.work/docs/wpmu-dev-plugins/powerform/#polls", target: "_blank", className: "sui-button sui-button-ghost" }, a.default.createElement("span", { className: "sui-icon-academy" }), " ", (0, i.translate)("Dokumentation anzeigen")) : "" }
    Object.defineProperty(t, "__esModule", { value: !0 }), t.default = r;
    var o = n(0),
        ...
        O = function(e) {
            ...
            return i(t, e), l(t, [{
                ...
                value: function(e, t) {
                    ...
                    if (!this.isValid()) { return new b.default({ type: "error", text: (0, p.translate)("Umfrageantworten dürfen nicht leer sein."), time: 4e3 }).open(), this.setState({ publishLoading: !1, draftLoading: !1 }), !1 }
                    if (!_.isUndefined(a) && a < 0) { return new b.default({ type: "error", text: (0, p.translate)("Bitte gib ein gültiges Abstimmungslimit ein."), time: 4e3 }).open(), this.setState({ publishLoading: !1, draftLoading: !1 }), !1 }
                    d.default.post(powerformData.ajaxUrl, m.default.stringify(e)).then(function(a) {
                        ...
                        else { new b.default({ type: "error", text: (0, p.translate)("Beim Speichern Deines Formulars ist ein Fehler aufgetreten. Bitte versuche es erneut.") }).open() }
                        n.setState({ publishLoading: !1, draftLoading: !1 })
                    }).catch(function(e) { new b.default({ type: "error", text: (0, p.translate)("Beim Speichern Deines Formulars ist ein Fehler aufgetreten. Bitte versuche es erneut.") }).open(), console.log(e), n.setState({ publishLoading: !1, draftLoading: !1 }) })
                }
    ...
    var i = function() {
        ...
        c = function(e) {
            ...
            return a(t, e), i(t, [{ key: "closeModal", value: function(e) { this.props.actions.modalActions.showModal({ open: !1, title: (0, u.translate)("Vorschau") }, "preview"), jQuery("#powerform-poll-styles-" + this.props.id).remove() } }, { key: "openModal", value: function(e) { this.props.actions.modalActions.showModal({ open: !0, title: (0, u.translate)("Vorschau"), closeModal: this.closeModal }, "preview") } }, { key: "render", value: function() { return l.default.createElement("button", { id: "powerform-preview-button", className: "sui-button sui-sidenav-hide-md", accessKey: "p", onClick: this.openModal, disabled: this.props.disabled }, l.default.createElement("i", { className: "sui-icon-eye", "aria-hidden": "true" }), " ", (0, u.translate)("Vorschau")) } }]), t
        }(s.Component);
    t.default = c
}, function(e, t, n) {
    "use strict";
    ...
    var s = function() {
        ...
        h = function(e) {
            function t(e) { return o(this, t), a(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this, e)) }
            return i(t, e), s(t, [{ key: "render", value: function() { return u.default.createElement(u.default.Fragment, null, u.default.createElement("ul", { className: "sui-vertical-tabs sui-sidenav-sticky sui-sidenav-hide-md fui-sidenav" }, u.default.createElement("li", { className: "sui-vertical-tab" }, u.default.createElement(c.NavLink, { to: "/builder", activeClassName: "current" }, (0, p.translate)("Details"))), u.default.createElement("li", { className: "sui-vertical-tab" }, u.default.createElement(c.NavLink, { to: "/appearance", activeClassName: "current" }, (0, p.translate)("Aussehen"))), u.default.createElement("li", { className: "sui-vertical-tab" }, u.default.createElement(c.NavLink, { to: "/behaviour", activeClassName: "current" }, (0, p.translate)("Verhalten"))), u.default.createElement("li", { className: "sui-vertical-tab" }, u.default.createElement(c.NavLink, { to: "/notifications", activeClassName: "current" }, (0, p.translate)("Benachrichtigungen"))), u.default.createElement("li", { className: "sui-vertical-tab" }, u.default.createElement(c.NavLink, { to: "/integrations", activeClassName: "current" }, (0, p.translate)("Integrationen"))), u.default.createElement("li", { className: "sui-vertical-tab" }, u.default.createElement(c.NavLink, { to: "/settings", activeClassName: "current" }, (0, p.translate)("Einstellungen")))), u.default.createElement(d.default, this.props, u.default.createElement("option", { value: "" }, (0, p.translate)("Details")), u.default.createElement("option", { value: "appearance" }, (0, p.translate)("Aussehen")), u.default.createElement("option", { value: "behaviour" }, (0, p.translate)("Verhalten")), u.default.createElement("option", { value: "notifications" }, (0, p.translate)("E-Mail-Benachrichtigungen")), u.default.createElement("option", { value: "integrations" }, (0, p.translate)("Integrationen")), u.default.createElement("option", { value: "settings" }, (0, p.translate)("Einstellungen")))) } }]), t
        }(l.Component);
    t.default = h
}, function(e, t, n) {
    "use strict";
    ...
    var s = Object.assign || function(e) { for (var t = 1; t < arguments.length; t++) { var n = arguments[t]; for (var r in n) Object.prototype.hasOwnProperty.call(n, r) && (e[r] = n[r]) } return e },
        ...
        v = function(e) {
            ...
            return i(t, e), l(t, [{ key: "render", value: function() { return c.default.createElement(c.default.Fragment, null, c.default.createElement("div", { className: "sui-box-settings-row" }, c.default.createElement("div", { className: "sui-box-settings-col-1" }, c.default.createElement("span", { className: "sui-settings-label" }, (0, p.translate)("Frage")), c.default.createElement("span", { className: "sui-description" }, (0, p.translate)("Füge zunächst die Frage hinzu, über die Du die Umfragebesucher abstimmen lassen möchtest."))), c.default.createElement("div", { className: "sui-box-settings-col-2" }, c.default.createElement(d.default, s({}, this.props, { label: (0, p.translate)("Was ist deine Hauptfrage?"), type: "text", placeholder: (0, p.translate)("Z.B. Warum hat das Huhn die Straße überquert?"), property: "poll-question" })), c.default.createElement(m.default, s({}, this.props, { type: "image", label: (0, p.translate)("Ausgewähltes Bild (optional)"), property: "poll-image", imageSize: "large", description: (0, p.translate)("Dieses Bild wird unter Deiner Hauptfrage angezeigt und kann zum Erstellen von Umfragen basierend auf einem Bild verwendet werden.") })), c.default.createElement(d.default, s({}, this.props, { label: (0, p.translate)("Beschreibung (optional)"), type: "text", placeholder: (0, p.translate)("Gib eine optionale Beschreibung ein"), property: "poll-description", description: (0, p.translate)("Dies wird unter der Hauptfrage angezeigt und kann zur weiteren Erläuterung der Hauptfrage verwendet werden.") })))), c.default.createElement("div", { className: "sui-box-settings-row sui-flushed", style: { borderBottom: "0" } }, c.default.createElement("div", { className: "sui-box-settings-col-2" }, c.default.createElement("label", { className: "sui-settings-label sui-dark" }, (0, p.translate)("Antworten")), c.default.createElement("span", { className: "sui-description" }, (0, p.translate)("Füge nun Antworten auf Deine Frage hinzu, mit denen Deine Benutzer abstimmen. Füge so viele hinzu, wie Du möchtest. Achte nur darauf, dass jede einzigartig ist!")), c.default.createElement(b.default, this.props))), c.default.createElement("div", { className: "sui-box-settings-row" }, c.default.createElement("div", { className: "sui-box-settings-col-1" }, c.default.createElement("span", { className: "sui-settings-label" }, (0, p.translate)("Schaltfläche")), c.default.createElement("span", { className: "sui-description" }, (0, p.translate)("Passe die Schaltflächenbezeichnung an, die zum Senden der Benutzerantwort verwendet wird."))), c.default.createElement("div", { className: "sui-box-settings-col-2" }, c.default.createElement(d.default, s({}, this.props, { label: (0, p.translate)("Schaltflächentext"), type: "text", placeholder: (0, p.translate)("Z. B. Abstimmen"), property: "poll-button-label" }))))) } }]), t
        }(u.Component);
    t.default = v
}, function(e, t, n) {
    "use strict";
    ...
    var l = Object.assign || function(e) { for (var t = 1; t < arguments.length; t++) { var n = arguments[t]; for (var r in n) Object.prototype.hasOwnProperty.call(n, r) && (e[r] = n[r]) } return e },
        ...
        m = function(e) {
            ...
            }, { key: "render", value: function() { var e = this; return p.default.createElement("div", { className: "fui-multi-answers", ref: function(t) { return e.el = t } }, p.default.createElement("ul", { className: "fui-answers" }, _.map(this.props.answers, function(t, n) { return p.default.createElement(h.default, l({ key: t.element_id, answer: t }, e.props, { counter: n })) })), p.default.createElement("button", { className: "sui-button sui-button-dashed", onClick: this.addAnswer }, p.default.createElement("i", { className: "sui-icon-plus", "aria-hidden": "true" }), (0, f.translate)("Antwort hinzufügen")), 0 === this.props.answers.length && p.default.createElement("div", { className: "fui-empty-message" }, p.default.createElement("span", { className: "sui-description" }, (0, f.translate)("Eine Umfrage ohne Antworten wird nicht sehr nützlich sein... Füge Deine Antworten oben hinzu!")), powerformData.showBranding && p.default.createElement("img", { src: powerformData.imagesUrl + "/powerform-create-modal.png", srcSet: powerformData.imagesUrl + "/powerform-create-modal.png 1x,\n\t\t\t\t\t\t\t\t" + powerformData.imagesUrl + "/powerform-create-modal@2x.png 2x", className: "sui-image sui-image-center" }))) } }]), t
        }(c.Component);
    t.default = m
}, function(e, t, n) {
    "use strict";
    ...
    var i = function() {
        ...
        c = function(e) {
            function t() { return r(this, t), o(this, (t.__proto__ || Object.getPrototypeOf(t)).apply(this, arguments)) }
            return a(t, e), i(t, [{ key: "render", value: function() { return l.default.createElement("div", { className: "sui-notice" }, l.default.createElement("p", null, (0, u.translate)("Du hast entschieden, dass kein Stylesheet in die Warteschlange gestellt werden soll. Das Formular erbt Stile vom CSS Deines Themes."))) } }]), t
        }(s.Component);
    t.default = c
}, function(e, t, n) {
    "use strict";
    ...
    var s = Object.assign || function(e) { for (var t = 1; t < arguments.length; t++) { var n = arguments[t]; for (var r in n) Object.prototype.hasOwnProperty.call(n, r) && (e[r] = n[r]) } return e },
        ...
        I = function(e) {
            function t(e) { return o(this, t), a(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this, e)) }
            return i(t, e), l(t, [{ key: "render", value: function() { return c.default.createElement("div", { className: "sui-box-settings-row" }, c.default.createElement("div", { className: "sui-box-settings-col-1" }, c.default.createElement("span", { className: "sui-settings-label" }, (0, p.translate)("Farben")), c.default.createElement("span", { className: "sui-description" }, (0, p.translate)("Passe die Standardfarbkombinationen an Dein Design an."))), c.default.createElement("div", { className: "sui-box-settings-col-2" }, c.default.createElement(d.default, s({}, this.props, { property: "poll-colors", default: "" }), c.default.createElement(m.default, { value: "" }, (0, p.translate)("Verwende Standardfarben")), c.default.createElement(b.default, { value: "true", label: (0, p.translate)("Benutzerdefiniert") }, c.default.createElement("div", { className: "sui-accordion" }, c.default.createElement("div", { className: "sui-accordion-header" }, c.default.createElement("div", null, (0, p.translate)("Element"))), c.default.createElement(g.default, s({}, this.props, { label: (0, p.translate)("Umfrage Container") }), c.default.createElement(w.default, this.props)), c.default.createElement(g.default, s({}, this.props, { label: (0, p.translate)("Umfrage-Grundlagen") }), c.default.createElement(C.default, this.props)), c.default.createElement(g.default, s({}, this.props, { label: (0, p.translate)("Auswahl Optionen") }), c.default.createElement(k.default, this.props)), c.default.createElement(g.default, s({}, this.props, { label: (0, p.translate)("Benutzerdefinierte Antworteingabe") }), c.default.createElement(T.default, this.props)), c.default.createElement(g.default, s({}, this.props, { label: (0, p.translate)("Senden-Schaltfläche") }), c.default.createElement(M.default, this.props)), c.default.createElement(g.default, s({}, this.props, { label: (0, p.translate)("Ergebnis anzeigen Link") }), c.default.createElement(F.default, this.props)), c.default.createElement(g.default, s({}, this.props, { label: (0, p.translate)("Antworterfolg") }), c.default.createElement(O.default, this.props)), c.default.createElement(g.default, s({}, this.props, { label: (0, p.translate)("Antwortfehler") }), c.default.createElement(x.default, this.props)), "none" !== (0, p.getChartType)(this.props.settings) && c.default.createElement(g.default, s({}, this.props, { label: (0, p.translate)("Ergebnistabelle") }), c.default.createElement(U.default, this.props))))))) } }]), t
        }(u.Component);
    t.default = I
}, function(e, t, n) {
    "use strict";
    ...
    var s = Object.assign || function(e) { for (var t = 1; t < arguments.length; t++) { var n = arguments[t]; for (var r in n) Object.prototype.hasOwnProperty.call(n, r) && (e[r] = n[r]) } return e },
        ...
        h = function(e) {
            function t(e) { return o(this, t), a(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this, e)) }
            return i(t, e), l(t, [{ key: "render", value: function() { return c.default.createElement(c.default.Fragment, null, c.default.createElement(d.default, s({}, this.props, { label: (0, p.translate)("Rahmenfarbe"), property: "box_border", defaultValue: "rgba(0,0,0,0)", isAlpha: !0 })), c.default.createElement(d.default, s({}, this.props, { label: (0, p.translate)("Hintergrundfarbe"), property: "box_background", defaultValue: "rgba(255,255,255,0)", isAlpha: !0 })), c.default.createElement(d.default, s({}, this.props, { label: (0, p.translate)("Box Schatten"), property: "box_shadow", defaultValue: "rgba(230,230,230,0)", isAlpha: !0 }))) } }]), t
        }(u.Component);
    t.default = h
}, function(e, t, n) {
    "use strict";
    ...
    var s = Object.assign || function(e) { for (var t = 1; t < arguments.length; t++) { var n = arguments[t]; for (var r in n) Object.prototype.hasOwnProperty.call(n, r) && (e[r] = n[r]) } return e },
        ...
        h = function(e) {
            function t(e) { return o(this, t), a(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this, e)) }
            return i(t, e), l(t, [{ key: "render", value: function() { return c.default.createElement(c.default.Fragment, null, c.default.createElement("p", { className: "sui-description" }, (0, p.translate)("Die Erfolgsmeldung wird angezeigt, nachdem die Übermittlung der Umfrage erfolgreich war.")), c.default.createElement(d.default, s({}, this.props, { label: (0, p.translate)("Rahmenfarbe"), property: "success_border", defaultValue: "#1ABCA1" })), c.default.createElement(d.default, s({}, this.props, { label: (0, p.translate)("Hintergrundfarbe"), property: "success_background", defaultValue: "#BCEEE6" })), c.default.createElement(d.default, s({}, this.props, { label: (0, p.translate)("Textfarbe"), property: "success_text", defaultValue: "#333333" }))) } }]), t
        }(u.Component);
    t.default = h
}, function(e, t, n) {
    "use strict";
    ...
    var s = Object.assign || function(e) { for (var t = 1; t < arguments.length; t++) { var n = arguments[t]; for (var r in n) Object.prototype.hasOwnProperty.call(n, r) && (e[r] = n[r]) } return e },
        ...
        h = function(e) {
            function t(e) { return o(this, t), a(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this, e)) }
            return i(t, e), l(t, [{ key: "render", value: function() { return c.default.createElement(c.default.Fragment, null, c.default.createElement("p", { className: "sui-description" }, (0, p.translate)("Die Fehlerantwortmeldung wird angezeigt, nachdem die Übermittlung der Abstimmung fehlgeschlagen ist.")), c.default.createElement(d.default, s({}, this.props, { label: (0, p.translate)("Rahmenfarbe"), property: "error_border", defaultValue: "#E04562" })), c.default.createElement(d.default, s({}, this.props, { label: (0, p.translate)("Hintergrundfarbe"), property: "error_background", defaultValue: "#F9E4E8" })), c.default.createElement(d.default, s({}, this.props, { label: (0, p.translate)("Textfarbe"), property: "error_text", defaultValue: "#333333" }))) } }]), t
        }(u.Component);
    t.default = h
}, function(e, t, n) {
    "use strict";
    ...
    var s = Object.assign || function(e) { for (var t = 1; t < arguments.length; t++) { var n = arguments[t]; for (var r in n) Object.prototype.hasOwnProperty.call(n, r) && (e[r] = n[r]) } return e },
        ...
        v = function(e) {
            function t(e) { return o(this, t), a(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this, e)) }
            return i(t, e), l(t, [{ key: "render", value: function() { return c.default.createElement(d.default, { type: "tabs", default: "default", extraClass: "sui-tabs-flushed" }, c.default.createElement(b.default, { value: "default", label: (0, p.translate)("Standard") }, c.default.createElement(m.default, s({}, this.props, { label: (0, p.translate)("Rahmenfarbe"), property: "inputbo", defaultValue: "rgba(119,119,113,1)", isAlpha: !0 })), c.default.createElement(m.default, s({}, this.props, { label: (0, p.translate)("Hintergrund"), property: "inputbg", defaultValue: "rgba(237,237,237,1)", isAlpha: !0 })), c.default.createElement(m.default, s({}, this.props, { label: (0, p.translate)("Textfarbe"), property: "poll_answers", defaultValue: "#000000" }))), c.default.createElement(b.default, { value: "checked", label: (0, p.translate)("Ausgewählt") }, c.default.createElement(m.default, s({}, this.props, { label: (0, p.translate)("Rahmenfarbe"), property: "inputbo_active", defaultValue: "rgba(23,168,227,1)", isAlpha: !0 })), c.default.createElement(m.default, s({}, this.props, { label: (0, p.translate)("Hintergrund"), property: "inputbg_active", defaultValue: "rgba(237,237,237,1)", isAlpha: !0 })), c.default.createElement(m.default, s({}, this.props, { label: (0, p.translate)("Symbolfarbe"), property: "radio_dot", defaultValue: "rgba(23,168,227,1)", isAlpha: !0 })))) } }]), t
        }(u.Component);
    t.default = v
}, function(e, t, n) {
    "use strict";
    ...
    var s = Object.assign || function(e) { for (var t = 1; t < arguments.length; t++) { var n = arguments[t]; for (var r in n) Object.prototype.hasOwnProperty.call(n, r) && (e[r] = n[r]) } return e },
        ...
        v = function(e) {
            function t(e) { return o(this, t), a(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this, e)) }
            return i(t, e), l(t, [{ key: "render", value: function() { return c.default.createElement(d.default, { type: "tabs", default: "default", extraClass: "sui-tabs-flushed" }, c.default.createElement(m.default, { value: "default", label: (0, p.translate)("Standard") }, c.default.createElement(b.default, s({}, this.props, { label: (0, p.translate)("Rahmenfarbe"), property: "powerform-poll-input-border_static", defaultValue: "rgba(119,119,113,1)", isAlpha: !0 })), c.default.createElement(b.default, s({}, this.props, { label: (0, p.translate)("Hintergrundfarbe"), property: "powerform-poll-input-background_static", defaultValue: "rgba(237,237,237,1)", isAlpha: !0 })), c.default.createElement(b.default, s({}, this.props, { label: (0, p.translate)("Platzhalter"), property: "input_placeholder", defaultValue: "#888888" })), c.default.createElement(b.default, s({}, this.props, { label: (0, p.translate)("Textfarbe"), property: "input_text", defaultValue: "#000000" }))), c.default.createElement(m.default, { value: "hover", label: (0, p.translate)("Hover") }, c.default.createElement(b.default, s({}, this.props, { label: (0, p.translate)("Rahmenfarbe"), property: "powerform-poll-input-border_hover", defaultValue: "rgba(23,168,227,1)", isAlpha: !0 })), c.default.createElement(b.default, s({}, this.props, { label: (0, p.translate)("Hintergrundfarbe"), property: "powerform-poll-input-background_hover", defaultValue: "rgba(230,230,230,1)", isAlpha: !0 }))), c.default.createElement(m.default, { value: "focus", label: (0, p.translate)("Focus") }, c.default.createElement(b.default, s({}, this.props, { label: (0, p.translate)("Rahmenfarbe"), property: "powerform-poll-input-border_active", defaultValue: "rgba(23,168,227,1)", isAlpha: !0 })), c.default.createElement(b.default, s({}, this.props, { label: (0, p.translate)("Hintergrundfarbe"), property: "powerform-poll-input-background_active", defaultValue: "rgba(230,230,230,1)", isAlpha: !0 })))) } }]), t
        }(u.Component);
    t.default = v
}, function(e, t, n) {
    "use strict";
    ...
    var s = Object.assign || function(e) { for (var t = 1; t < arguments.length; t++) { var n = arguments[t]; for (var r in n) Object.prototype.hasOwnProperty.call(n, r) && (e[r] = n[r]) } return e },
        ...
        v = function(e) {
            function t(e) { return o(this, t), a(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this, e)) }
            return i(t, e), l(t, [{ key: "render", value: function() { return c.default.createElement(d.default, { type: "tabs", default: "default", extraClass: "sui-tabs-flushed" }, c.default.createElement(m.default, { value: "default", label: (0, p.translate)("Standard") }, c.default.createElement(b.default, s({}, this.props, { label: (0, p.translate)("Hintergrundfarbe"), property: "buttonbg", defaultValue: "rgba(23,168,227,1)", isAlpha: !0 })), c.default.createElement(b.default, s({}, this.props, { label: (0, p.translate)("Textfarbe"), property: "buttontxt", defaultValue: "rgba(255,255,255,1)", isAlpha: !0 }))), c.default.createElement(m.default, { value: "hover", label: (0, p.translate)("Hover") }, c.default.createElement(b.default, s({}, this.props, { label: (0, p.translate)("Hintergrundfarbe"), property: "buttonbg_hover", defaultValue: "rgba(0,143,202,1)", isAlpha: !0 })), c.default.createElement(b.default, s({}, this.props, { label: (0, p.translate)("Textfarbe"), property: "buttontxt_hover", defaultValue: "rgba(255,255,255,1)", isAlpha: !0 }))), c.default.createElement(m.default, { value: "active", label: (0, p.translate)("Aktiv") }, c.default.createElement(b.default, s({}, this.props, { label: (0, p.translate)("Hintergrundfarbe"), property: "buttonbg_active", defaultValue: "rgba(0,143,202,1)", isAlpha: !0 })), c.default.createElement(b.default, s({}, this.props, { label: (0, p.translate)("Textfarbe"), property: "buttontxt_active", defaultValue: "rgba(255,255,255,1)", isAlpha: !0 })))) } }]), t
        }(u.Component);
    t.default = v
}, function(e, t, n) {
    "use strict";
    ...
    var s = Object.assign || function(e) { for (var t = 1; t < arguments.length; t++) { var n = arguments[t]; for (var r in n) Object.prototype.hasOwnProperty.call(n, r) && (e[r] = n[r]) } return e },
        ...
        w = function(e) {
            function t(e) { return o(this, t), a(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this, e)) }
            return i(t, e), l(t, [{ key: "render", value: function() { var e = this; return c.default.createElement(d.default, { type: "tabs", default: "basics", extraClass: "sui-tabs-flushed" }, c.default.createElement(m.default, { value: "basics", label: (0, p.translate)("Grundlagen") }, "bar" === (0, p.getChartType)(this.props.settings) && c.default.createElement(b.default, s({}, this.props, { label: (0, p.translate)("Diagrammgitterlinien"), property: "grid_lines", defaultValue: "#E5E5E5" })), c.default.createElement(b.default, s({}, this.props, { label: "pie" === (0, p.getChartType)(this.props.settings) ? (0, p.translate)("Legende Textfarbe") : (0, p.translate)("Farbe der Diagrammbeschriftungen"), description: "pie" === (0, p.getChartType)(this.props.settings) ? (0, p.translate)("Legenden werden immer oben im Diagramm angezeigt.") : "", property: "grid_labels", defaultValue: "#777771" })), "bar" === (0, p.getChartType)(this.props.settings) && c.default.createElement(b.default, s({}, this.props, { label: (0, p.translate)("Stimmen zählen"), property: "onbar_votes", description: (0, p.translate)("Text wird in Balken angezeigt."), defaultValue: "#333333", isAlpha: !0 }))), c.default.createElement(m.default, { value: "tooltips", label: (0, p.translate)("Tooltips") }, c.default.createElement(b.default, s({}, this.props, { label: (0, p.translate)("Hintergrundfarbe"), property: "tooltips_background", defaultValue: "#333333", isAlpha: !0 })), c.default.createElement(b.default, s({}, this.props, { label: (0, p.translate)("Textfarbe"), property: "tooltips_text", defaultValue: "#FFFFFF" }))), c.default.createElement(m.default, { value: "votes", label: (0, p.translate)("Antworten") }, c.default.createElement("p", { class: "sui-description" }, (0, p.translate)("Wähle die Diagrammfarben für jede unten stehende Umfrageantwort aus.")), _.map(this.props.answers, function(t, n) { return c.default.createElement(g.default, s({}, e.props, { key: t.element_id, answer: t, counter: n })) }))) } }]), t
        }(u.Component);
    t.default = w
}, function(e, t, n) {
    "use strict";
    ...
    var s = Object.assign || function(e) { for (var t = 1; t < arguments.length; t++) { var n = arguments[t]; for (var r in n) Object.prototype.hasOwnProperty.call(n, r) && (e[r] = n[r]) } return e },
        ...
        _ = function(e) {
            function t() { return o(this, t), a(this, (t.__proto__ || Object.getPrototypeOf(t)).apply(this, arguments)) }
            return i(t, e), l(t, [{ key: "render", value: function() { return c.default.createElement("div", { className: "sui-box-settings-row" }, c.default.createElement("div", { className: "sui-box-settings-col-1" }, c.default.createElement("span", { className: "sui-settings-label" }, (0, p.translate)("Formularcontainer")), c.default.createElement("span", { className: "sui-description" }, (0, p.translate)("Passe den Abstand und den Rand des Formularcontainers an."))), c.default.createElement("div", { className: "sui-box-settings-col-2" }, c.default.createElement(g.default, s({}, this.props, { property: "poll-padding", settingsLabel: (0, p.translate)("Innenabstand"), settingsDesc: (0, p.translate)("Standardmäßig füllt das Formular den verfügbaren Platz, an dem Du es einfügst. Du kannst hier etwas Polsterung hinzufügen, um besser zu Deinem Theme zu passen.") }), c.default.createElement(d.default, { value: "" }, (0, p.translate)("Keinen")), c.default.createElement(m.default, s({}, this.props, { value: "custom", boxClass: "sui-tab-boxed" }), (0, p.translate)("Benutzerdefiniert"))), c.default.createElement(g.default, s({}, this.props, { property: "poll-border", settingsLabel: (0, p.translate)("Rahmen"), settingsDesc: (0, p.translate)("Füge dem Formular einen optionalen Rahmen hinzu.") }), c.default.createElement(d.default, { value: "" }, (0, p.translate)("Keinen")), c.default.createElement(b.default, s({}, this.props, { value: "custom", boxClass: "sui-tab-boxed" }), (0, p.translate)("Benutzerdefiniert"))))) } }]), t
        }(u.Component);
    t.default = _
}, function(e, t, n) {
    "use strict";
    ...
    var s = Object.assign || function(e) { for (var t = 1; t < arguments.length; t++) { var n = arguments[t]; for (var r in n) Object.prototype.hasOwnProperty.call(n, r) && (e[r] = n[r]) } return e },
        ...
        y = function(e) {
            function t(e) { return o(this, t), a(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this, e)) }
            return i(t, e), l(t, [{ key: "render", value: function() { return c.default.createElement(c.default.Fragment, null, c.default.createElement("div", { className: "sui-row", style: { marginBottom: "10px" } }, c.default.createElement(d.default, { cols: "3" }, c.default.createElement(m.default, s({}, this.props, { label: (0, p.translate)("Oben"), type: "number", placeholder: "0", defaultValue: "20", property: "powerform-poll-padding-top" }))), c.default.createElement(d.default, { cols: "3" }, c.default.createElement(m.default, s({}, this.props, { label: (0, p.translate)("Unten"), type: "number", placeholder: "0", defaultValue: "20", property: "powerform-poll-padding-bottom" }))), c.default.createElement(d.default, { cols: "3" }, c.default.createElement(m.default, s({}, this.props, { label: (0, p.translate)("Links"), type: "number", placeholder: "0", defaultValue: "20", property: "powerform-poll-padding-left" }))), c.default.createElement(d.default, { cols: "3" }, c.default.createElement(m.default, s({}, this.props, { label: (0, p.translate)("Rechts"), type: "number", placeholder: "0", defaultValue: "20", property: "powerform-poll-padding-right" })))), c.default.createElement("span", { className: "sui-description" }, (0, p.translate)("Stelle Deine benutzerdefinierte Polsterung in Pixel ein."))) } }]), t
        }(u.Component);
    t.default = y
}, function(e, t, n) {
    "use strict";
    ...
    var s = Object.assign || function(e) { for (var t = 1; t < arguments.length; t++) { var n = arguments[t]; for (var r in n) Object.prototype.hasOwnProperty.call(n, r) && (e[r] = n[r]) } return e },
        ...
        v = function(e) {
            function t(e) { return o(this, t), a(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this, e)) }
            return i(t, e), l(t, [{ key: "render", value: function() { return c.default.createElement(c.default.Fragment, null, c.default.createElement("div", { className: "sui-row", style: { marginBottom: "10px" } }, c.default.createElement(d.default, { cols: "4" }, c.default.createElement(m.default, s({}, this.props, { label: (0, p.translate)("Radius"), note: (0, p.translate)("in px"), type: "number", placeholder: "0", defaultValue: "4", property: "powerform-poll-border-radius" }))), c.default.createElement(d.default, { cols: "4" }, c.default.createElement(m.default, s({}, this.props, { label: (0, p.translate)("Dicke"), note: (0, p.translate)("in px"), type: "number", placeholder: "0", defaultValue: "1", property: "powerform-poll-border-width" }))), c.default.createElement(d.default, { cols: "4" }, c.default.createElement(b.default, s({ property: "powerform-poll-border-style", label: (0, p.translate)("Stil") }, this.props), c.default.createElement("option", { value: "solid" }, (0, p.translate)("Fest")), c.default.createElement("option", { value: "dashed" }, (0, p.translate)("Gestrichelt")), c.default.createElement("option", { value: "dotted" }, (0, p.translate)("Gepunktet")), c.default.createElement("option", { value: "none" }, (0, p.translate)("Keinen"))))), c.default.createElement("span", { className: "sui-description" }, (0, p.translate)("Hinweis: Lege die Farbe des Rahmens im Bereich Farbeneinstellungen oben fest."))) } }]), t
        }(u.Component);
    t.default = v
}, function(e, t, n) {
    "use strict";
    ...
    var s = Object.assign || function(e) { for (var t = 1; t < arguments.length; t++) { var n = arguments[t]; for (var r in n) Object.prototype.hasOwnProperty.call(n, r) && (e[r] = n[r]) } return e },
        ...
        y = function(e) {
            function t(e) { return o(this, t), a(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this, e)) }
            return i(t, e), l(t, [{ key: "render", value: function() { return c.default.createElement("div", { className: "sui-box-settings-row" }, c.default.createElement("div", { className: "sui-box-settings-col-1" }, c.default.createElement("span", { className: "sui-settings-label" }, (0, p.translate)("Benutzerdefinierte CSS")), c.default.createElement("span", { className: "sui-description" }, (0, p.translate)("Verwende für erweiterte Anpassungsoptionen benutzerdefiniertes CSS."))), c.default.createElement("div", { className: "sui-box-settings-col-2" }, c.default.createElement("div", { className: "sui-form-field" }, c.default.createElement("div", { style: { marginBottom: "10px" } }, c.default.createElement(d.default, s({}, this.props, { label: (0, p.translate)("Aktiviere benutzerdefiniertes CSS"), property: "use-custom-css", unWrap: !0 }))), !_.isUndefined(this.props.settings["use-custom-css"]) && this.props.settings["use-custom-css"] && c.default.createElement(m.default, s({}, this.props, { property: "custom_css", type: "poll" }))))) } }]), t
        }(u.Component);
    t.default = y
}, function(e, t, n) {
    "use strict";
        ...
        w = function(e) {
            ...
            return i(t, e), l(t, [{
                ...
                value: function() {
                    var e = this,
                        t = function(t) { e.props.history.push("/" + t) },
                        n = c.default.createElement(_.default, s({}, this.props, { defaultValue: "bar", property: "results-style", radioClass: "sui-radio-sm" }), c.default.createElement("div", { value: "pie", image1x: "graph-pie.png", image2x: "graph-pie@2x.png", hasImage: !0 }, (0, p.translate)("Kuchendiagramm")), c.default.createElement("div", { value: "bar", image1x: "graph-bar.png", image2x: "graph-bar@2x.png", hasImage: !0 }, (0, p.translate)("Balkendiagramm")));
                    return c.default.createElement("div", { className: "sui-box-settings-row" }, c.default.createElement("div", { className: "sui-box-settings-col-1" }, c.default.createElement("span", { className: "sui-settings-label" }, (0, p.translate)("Ergebnisanzeige")), c.default.createElement("span", { className: "sui-description" }, (0, p.translate)("Wähle aus, wie Du die Umfrageergebnisse für neue Einreichungen anzeigen möchtest. Du kannst Farben auf der Registerkarte {{link}}Darstellung{{/link}} anpassen.", { components: { link: c.default.createElement("a", { href: "#", onClick: function() { return t("appearance") } }) } }))), c.default.createElement("div", { className: "sui-box-settings-col-2" }, c.default.createElement(v.default, s({}, this.props, { property: "results-behav", default: "not_show" }), c.default.createElement(m.default, s({}, this.props, { value: "link_on", label: (0, p.translate)("Link zur Umfrage"), boxClass: "sui-tab-boxed" }), n), c.default.createElement(m.default, s({}, this.props, { value: "show_after", label: (0, p.translate)("Zeige nach der Abstimmung"), boxClass: "sui-tab-boxed" }), n), c.default.createElement(d.default, { value: "not_show", label: (0, p.translate)("Nicht zeigen") }))))
                }
            }]), t
        }(u.Component);
    t.default = w
    ...
    var s = Object.assign || function(e) { for (var t = 1; t < arguments.length; t++) { var n = arguments[t]; for (var r in n) Object.prototype.hasOwnProperty.call(n, r) && (e[r] = n[r]) } return e },
        ...
        h = function(e) {
            function t(e) { return o(this, t), a(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this, e)) }
            return i(t, e), l(t, [{ key: "render", value: function() { return c.default.createElement("div", { className: "sui-box-settings-row" }, c.default.createElement("div", { className: "sui-box-settings-col-1" }, c.default.createElement("span", { className: "sui-settings-label" }, (0, p.translate)("Stimmenzahl")), c.default.createElement("span", { className: "sui-description" }, (0, p.translate)("Zeige die Anzahl der Stimmen in den Balkendiagrammergebnissen an"))), c.default.createElement("div", { className: "sui-box-settings-col-2" }, c.default.createElement(d.default, s({}, this.props, { property: "show-votes-count", defaultValue: "false" }), c.default.createElement("div", { value: "false" }, (0, p.translate)("Ausblenden")), c.default.createElement("div", { value: "true" }, (0, p.translate)("Anzeigen"))))) } }]), t
        }(u.Component);
    t.default = h
}, function(e, t, n) {
    "use strict";
    ...
    var s = Object.assign || function(e) { for (var t = 1; t < arguments.length; t++) { var n = arguments[t]; for (var r in n) Object.prototype.hasOwnProperty.call(n, r) && (e[r] = n[r]) } return e },
        ...
        h = function(e) {
            function t(e) { return o(this, t), a(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this, e)) }
            return i(t, e), l(t, [{ key: "render", value: function() { return c.default.createElement("div", { className: "sui-box-settings-row" }, c.default.createElement("div", { className: "sui-box-settings-col-1" }, c.default.createElement("span", { className: "sui-settings-label" }, (0, p.translate)("Einreichungsmethode")), c.default.createElement("span", { className: "sui-description" }, (0, p.translate)("Bei Einsendungen muss die Seite standardmäßig nicht neu geladen werden. Wenn Du Probleme hast, kannst Du die herkömmliche Methode zum erneuten Laden der Seite verwenden."))), c.default.createElement("div", { className: "sui-box-settings-col-2" }, c.default.createElement(d.default, s({}, this.props, { property: "enable-ajax", defaultValue: "" }), c.default.createElement("div", { value: "" }, (0, p.translate)("Seite neuladen")), c.default.createElement("div", { value: "true" }, (0, p.translate)("Ajax"))))) } }]), t
        }(u.Component);
    t.default = h
}, function(e, t, n) {
    "use strict";
    ...
    var s = Object.assign || function(e) { for (var t = 1; t < arguments.length; t++) { var n = arguments[t]; for (var r in n) Object.prototype.hasOwnProperty.call(n, r) && (e[r] = n[r]) } return e },
        ...
        P = function(e) {
            function t(e) { return o(this, t), a(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this, e)) }
            return i(t, e), l(t, [{ key: "render", value: function() { return c.default.createElement("div", { className: "sui-box-settings-row" }, c.default.createElement("div", { className: "sui-box-settings-col-1" }, c.default.createElement("span", { className: "sui-settings-label" }, (0, p.translate)("Abstimmungszeitraum")), c.default.createElement("span", { className: "sui-description" }, (0, p.translate)("Wähle aus, wann Du die Abstimmung öffnen und schließen möchtest"))), c.default.createElement("div", { className: "sui-box-settings-col-2" }, c.default.createElement("div", { className: "sui-form-field" }, c.default.createElement("label", { className: "sui-settings-label" }, (0, p.translate)("Status")), c.default.createElement("span", { className: "sui-description" }, (0, p.translate)("Wähle Status der Abstimmung")), c.default.createElement(d.default, s({}, this.props, { property: "opening_status", default: "open", simple: !0 }), c.default.createElement(m.default, { value: "open", label: (0, p.translate)("Offen") }), c.default.createElement(m.default, { value: "pause", label: (0, p.translate)("Pausiert") }), c.default.createElement(m.default, { value: "close", label: (0, p.translate)("Geschlossen") }))), c.default.createElement("div", { className: "sui-form-field" }, c.default.createElement("label", { className: "sui-settings-label" }, (0, p.translate)("Offen von")), c.default.createElement("span", { className: "sui-description" }, (0, p.translate)("Wähle aus, wann die Abstimmung eröffnet werden soll")), c.default.createElement(d.default, s({}, this.props, { property: "opening_open_from", default: "now", simple: !0 }), c.default.createElement(m.default, { value: "now", label: (0, p.translate)("Jetzt") }), c.default.createElement(b.default, s({}, this.props, { value: "specific_date_time", label: (0, p.translate)("Spezifisches Datum/Uhrzeit"), boxClass: "sui-tab-boxed" }), c.default.createElement(g.default, { cols: "12" }, c.default.createElement(x.default, s({}, this.props, { property: "opening_open_from_date_time" })))))), c.default.createElement("div", { className: "sui-form-field" }, c.default.createElement("label", { className: "sui-settings-label" }, (0, p.translate)("Offen bis")), c.default.createElement("span", { className: "sui-description" }, (0, p.translate)("Wähle aus, wie lange die Abstimmung offen bleiben soll")), c.default.createElement(d.default, s({}, this.props, { property: "opening_open_until", default: "forever", simple: !0 }), c.default.createElement(m.default, { value: "forever", label: (0, p.translate)("Für immer") }), c.default.createElement(b.default, s({}, this.props, { value: "specific_date_time", label: (0, p.translate)("Spezifisches Datum/Uhrzeit"), boxClass: "sui-tab-boxed" }), c.default.createElement(g.default, { cols: "12" }, c.default.createElement(x.default, s({}, this.props, { property: "opening_open_until_date_time" })))))), c.default.createElement("div", { className: "sui-form-field" }, c.default.createElement("label", { className: "sui-settings-label" }, (0, p.translate)("Benutzerdefinierte Nachrichten")), c.default.createElement(w.default, s({}, this.props, { label: (0, p.translate)("Nachricht bei geschlossener Abstimmung"), type: "text", property: "opening_close_msg", placeholder: (0, p.translate)("Z.B. Die Abstimmung ist geschlossen") })), c.default.createElement(w.default, s({}, this.props, { label: (0, p.translate)("Nachricht, wenn die Abstimmung pausiert ist"), type: "text", property: "opening_pause_msg", placeholder: (0, p.translate)("Z. B. Die Abstimmung ist pausiert. Schau später noch mal vorbei.") })), c.default.createElement(w.default, s({}, this.props, { label: (0, p.translate)("Nachricht vor dem Abstimmungsstart"), type: "text", property: "opening_before_open_from_msg", placeholder: (0, p.translate)("Z.B. Die Abstimmung wurde noch nicht gestartet") }))))) } }]), t
        }(u.Component);
    t.default = P
}, function(e, t, n) {
    "use strict";
    ...
    var s = Object.assign || function(e) { for (var t = 1; t < arguments.length; t++) { var n = arguments[t]; for (var r in n) Object.prototype.hasOwnProperty.call(n, r) && (e[r] = n[r]) } return e },
        ...
        P = function(e) {
            function t(e) { return o(this, t), a(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this, e)) }
            return i(t, e), l(t, [{ key: "render", value: function() { return c.default.createElement("div", { className: "sui-box-settings-row" }, c.default.createElement("div", { className: "sui-box-settings-col-1" }, c.default.createElement("span", { className: "sui-settings-label" }, (0, p.translate)("Abstimmungslimit")), c.default.createElement("span", { className: "sui-description" }, (0, p.translate)("Wähle aus, ob Du die Anzahl der Stimmen pro Benutzer begrenzen möchtest und wie Du diese Begrenzung festlegen möchtest. "))), c.default.createElement("div", { className: "sui-box-settings-col-2" }, c.default.createElement("div", { className: "sui-form-field" }, c.default.createElement("label", { className: "sui-settings-label" }, (0, p.translate)("Stimmen pro Benutzer")), c.default.createElement("span", { className: "sui-description", style: { marginBottom: "20px" } }, (0, p.translate)("Standardmäßig kann ein Benutzer nur einmal über eine Umfrage abstimmen. Du kannst den Benutzern jedoch erlauben, mehrmals abzustimmen, und auch die Zeit angeben, nach der ein Benutzer erneut abstimmen kann.")), c.default.createElement(d.default, s({}, this.props, { property: "enable-votes-limit", default: "false", simple: !0 }), c.default.createElement(m.default, { value: "false", label: (0, p.translate)("Einmal") }), c.default.createElement(b.default, s({}, this.props, { value: "true", label: (0, p.translate)("Mehrfach zulassen"), boxClass: "sui-tab-boxed" }), c.default.createElement(g.default, { cols: "6" }, c.default.createElement(w.default, s({}, this.props, { type: "number", property: "vote_limit_input", placeholder: "10", minValue: "0", isPositive: !0 }))), c.default.createElement(g.default, { cols: "6" }, c.default.createElement(O.default, s({}, this.props, { property: "vote_limit_options", defaultValue: "m" }), c.default.createElement("option", { value: "m" }, (0, p.translate)("Minute(n)")), c.default.createElement("option", { value: "h" }, (0, p.translate)("Stunde(n)")), c.default.createElement("option", { value: "d" }, (0, p.translate)("Tag(e)")), c.default.createElement("option", { value: "W" }, (0, p.translate)("Woche(n)")), c.default.createElement("option", { value: "M" }, (0, p.translate)("Monat(e)")), c.default.createElement("option", { value: "Y" }, (0, p.translate)("Jahr(e)"))))))), c.default.createElement("div", { className: "sui-form-field" }, c.default.createElement("label", { className: "sui-settings-label" }, (0, p.translate)("Methode")), c.default.createElement("span", { className: "sui-description" }, (0, p.translate)("Wähle die Methode, mit der Du die Anzahl der Stimmen begrenzen möchtest.")), c.default.createElement(x.default, s({}, this.props, { property: "enable-votes-method", defaultValue: "user_ip" }), c.default.createElement("div", { value: "user_ip" }, (0, p.translate)("Benutzer-IP")), c.default.createElement("div", { value: "browser_cookie" }, (0, p.translate)("Browser-Cookie")))))) } }]), t
        }(u.Component);
    t.default = P
}, function(e, t, n) {
    "use strict";
    ...
    var s = Object.assign || function(e) { for (var t = 1; t < arguments.length; t++) { var n = arguments[t]; for (var r in n) Object.prototype.hasOwnProperty.call(n, r) && (e[r] = n[r]) } return e },
        ...
        h = function(e) {
            function t() { return o(this, t), a(this, (t.__proto__ || Object.getPrototypeOf(t)).apply(this, arguments)) }
            return i(t, e), l(t, [{ key: "render", value: function() { return c.default.createElement("div", { className: "sui-box-settings-row" }, c.default.createElement("div", { className: "sui-box-settings-col-1" }, c.default.createElement("span", { className: "sui-settings-label" }, (0, p.translate)("Rendern")), c.default.createElement("span", { className: "sui-description" }, (0, p.translate)("Wähle aus, wie Deine Umfrage für Benutzer gerendert werden soll."))), c.default.createElement("div", { className: "sui-box-settings-col-2" }, c.default.createElement(d.default, s({}, this.props, { property: "use_ajax_load", label: (0, p.translate)("Umfrage mit AJAX laden"), description: (0, p.translate)("Durch Aktivieren dieser Funktion wird die Umfrage über AJAX geladen, nachdem die Seite geladen wurde, wodurch die Ladezeit Deiner Seite effektiv beschleunigt wird. Diese Methode kann (in den meisten Fällen) auch Probleme beim Zwischenspeichern von Seiten bei Deiner Umfrage vermeiden.") })), c.default.createElement(d.default, s({}, this.props, { property: "use_donotcachepage", label: (0, p.translate)("Verhindere das Zwischenspeichern von Seiten auf Umfrageseiten"), description: (0, p.translate)("Plugins zum Zwischenspeichern von Seiten stellen eine statische HTML-Version der Seite bereit, die Probleme bei Deinen dynamischen Abfragen verursachen kann. Wenn Du dies aktivierst, verwenden wir die Konstante {{strong}}DONOTCACHEPAGE{{/strong}}, um zu verhindern, dass Seiten mit dieser Umfrage zwischengespeichert werden.", { components: { strong: c.default.createElement("strong", null) } }) })))) } }]), t
        }(u.Component);
    t.default = h
}, function(e, t, n) {
    "use strict";
    ...
    var s = Object.assign || function(e) { for (var t = 1; t < arguments.length; t++) { var n = arguments[t]; for (var r in n) Object.prototype.hasOwnProperty.call(n, r) && (e[r] = n[r]) } return e },
        ...
        x = function(e) {
            function t() { return o(this, t), a(this, (t.__proto__ || Object.getPrototypeOf(t)).apply(this, arguments)) }
            return i(t, e), l(t, [{ key: "getNameOptions", value: function() { var e = []; return _.map(powerformData.variables, function(t, n) { e.push({ label: t, value: n }) }), e } }, { key: "getEmailOptions", value: function() { return [] } }, { key: "getRecipientTagsOptions", value: function() { return { tags: !0, tokenSeparators: [",", " "], language: { searching: function() { return (0, p.translate)("Suchen") }, noResults: function() { return (0, p.translate)("Keine Einträge gefunden") } }, placeholder: (0, p.translate)("Empfänger"), ajax: { url: powerformData.ajaxUrl, type: "POST", delay: 350, data: function(e) { return { action: "powerform_builder_search_emails", _wpnonce: powerformData.searchNonce, q: e.term } }, processResults: function(e) { return { results: e.data } }, cache: !0 }, templateResult: function(e) { return _.isUndefined(e.id) || _.isUndefined(e.text) || _.isUndefined(e.display_name) ? e.text : jQuery("<span><b>" + e.text + "</b> - <small>" + e.display_name + "</small></span>") }, createTag: function(e) { var t = jQuery.trim(e.term); return (0, p.isEmailWp)(t) ? { id: t, text: t } : null } } } }, { key: "getCcBccOptions", value: function() { return { tags: !0, placeholder: (0, p.translate)("Keinen"), createTag: function(e) { var t = jQuery.trim(e.term); return (0, p.isEmailWp)(t) ? { id: t, text: t } : null } } } }, {
                ...
                value: function() {
                    var e = this.getEmailOptions();
                    e.unshift({ value: "", label: (0, p.translate)("Standard") });
                    var t = [];
                ...
                value: function() {
                    var e = this.getEmailOptions();
                    e.unshift({ value: "", label: (0, p.translate)("Keinen") });
                    var t = [];
                    e.map(function(e) { t.push(e.value) });
                    var n = _.isUndefined(this.props.settings["admin-email-reply-to-address"]) ? "" : this.props.settings["admin-email-reply-to-address"];
                    return t.indexOf(n) < 0 && e.push({ value: n, label: n }), e
                }
            }, { key: "render", value: function() { return this.getEmailOptions().unshift({ value: "", label: (0, p.translate)("Standard") }), this.getEmailOptions().unshift({ value: "", label: (0, p.translate)("Keinen") }), c.default.createElement("div", { className: "sui-box-settings-row" }, c.default.createElement("div", { className: "sui-box-settings-col-1" }, c.default.createElement("span", { className: "sui-settings-label" }, (0, p.translate)("Admin-E-Mail")), c.default.createElement("span", { className: "sui-description" }, (0, p.translate)("Optional kannst Du eine Benachrichtigungs-E-Mail an angegebene E-Mail-Konten senden, wenn Umfrageergebnisse eingehen."))), c.default.createElement("div", { className: "sui-box-settings-col-2" }, c.default.createElement("div", { className: "sui-form-field", style: { marginBottom: "10px" } }, c.default.createElement(m.default, s({}, this.props, { property: "use-admin-email", label: (0, p.translate)("Sende eine E-Mail an Administratorbenutzer"), unWrap: !0 }))), !_.isUndefined(this.props.settings["use-admin-email"]) && this.props.settings["use-admin-email"] && c.default.createElement("div", { className: "sui-border-frame sui-toggle-content" }, c.default.createElement(E.default, s({}, this.props, { property: "admin-email-from-name", placeholder: (0, p.translate)("Standard"), label: (0, p.translate)("Von Name") }), this.getNameOptions().map(function(e, t) { return c.default.createElement("option", { key: t, value: e.value, "data-content": e.value }, e.label) })), c.default.createElement(j.default, s({}, this.props, { property: "admin-email-from-address", label: (0, p.translate)("Von Adresse"), defaultValue: "", options: this.getAutoCreateEmailAddressOptions() }), this.getFromAddressOptions().map(function(e, t) { return c.default.createElement("option", { key: t, value: e.value }, e.label) })), c.default.createElement(b.default, s({}, this.props, { property: "admin-email-recipients", placeholder: (0, p.translate)("Empfänger"), options: this.getRecipientTagsOptions(), label: (0, p.translate)("Empfänger") })), c.default.createElement(j.default, s({}, this.props, { property: "admin-email-reply-to-address", label: (0, p.translate)("Antwortadresse"), defaultValue: "", options: this.getAutoCreateEmailAddressOptions() }), this.getReplyToAddressOptions().map(function(e, t) { return c.default.createElement("option", { key: t, value: e.value }, e.label) })), c.default.createElement(j.default, s({}, this.props, { property: "admin-email-cc-address", label: (0, p.translate)("CC-Adressen"), options: this.getCcBccOptions(), defaultValue: [], multiple: "true" }), this.getCcAddressesOptions().map(function(e, t) { return c.default.createElement("option", { key: t, value: e.value }, e.label) })), c.default.createElement(j.default, s({}, this.props, { property: "admin-email-bcc-address", label: (0, p.translate)("BCC-Adressen"), options: this.getCcBccOptions(), defaultValue: [], multiple: "true" }), this.getBccAddressesOptions().map(function(e, t) { return c.default.createElement("option", { key: t, value: e.value }, e.label) })), c.default.createElement(d.default, s({}, this.props, { property: "admin-email-title", placeholder: (0, p.translate)("Betreff eingeben"), label: (0, p.translate)("Betreff"), defaultValue: "" })), c.default.createElement(g.default, s({}, this.props, { property: "admin-email-editor", editorOptions: powerformData.variables, enableFormData: !1, boxClass: "sui-tab-boxed", mainOptions: { poll_name: (0, p.translate)("Umfragename"), poll_answer: (0, p.translate)("Umfrageantwort"), poll_result: (0, p.translate)("Umfrageergebnis") }, label: (0, p.translate)("Inhalt") }))))) } }]), t
        }(u.Component);
    t.default = x
}, function(e, t, n) {
    "use strict";
        ...
        m = function(e) {
            ...
            return i(t, e), s(t, [{ key: "componentDidMount", value: function() { jQuery("html, body").animate({ scrollTop: 0 }, "fast") } }, {
                ...
                value: function() {
                    var e = this,
                        t = function(t) { e.props.history.push("/" + t) };
                    return u.default.createElement("div", { id: "powerform-form-appearance", className: "sui-box" }, u.default.createElement("div", { className: "sui-box-header" }, u.default.createElement("h2", { className: "sui-box-title" }, (0, c.translate)("Einstellungen"))), u.default.createElement("div", { className: "sui-box-body" }, u.default.createElement(f.default, this.props), u.default.createElement(h.default, this.props)), u.default.createElement("div", { className: "sui-box-footer" }, u.default.createElement("button", { className: "sui-button", onClick: function() { return t("integrations") } }, u.default.createElement("i", { className: "sui-icon-arrow-left", "aria-hidden": "true" }), " ", (0, c.translate)("Integrationen"))))
                }
            }]), t
        }(l.Component);
    t.default = m
    ...
    var s = Object.assign || function(e) { for (var t = 1; t < arguments.length; t++) { var n = arguments[t]; for (var r in n) Object.prototype.hasOwnProperty.call(n, r) && (e[r] = n[r]) } return e },
        ...
        h = function(e) {
            function t(e) { return o(this, t), a(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this, e)) }
            return i(t, e), l(t, [{ key: "render", value: function() { return c.default.createElement("div", { className: "sui-box-settings-row" }, c.default.createElement("div", { className: "sui-box-settings-col-1" }, c.default.createElement("span", { className: "sui-settings-label" }, (0, p.translate)("Datenspeicher")), c.default.createElement("span", { className: "sui-description" }, (0, p.translate)("Standardmäßig speichern wir alle Einsendungen in Deiner Datenbank."))), c.default.createElement("div", { className: "sui-box-settings-col-2" }, c.default.createElement(d.default, s({}, this.props, { property: "store", label: (0, p.translate)("Deaktiviere Speicherübermittlungen in meiner Datenbank"), description: (0, p.translate)("Wenn Du keine Beiträge in Deiner Datenbank speichern möchtest, kannst Du diese Funktion deaktivieren. Alternativ kannst Du auch das automatische Löschen von Einsendungen nach einem bestimmten Zeitraum planen.") })))) } }]), t
        }(u.Component);
    t.default = h
}, function(e, t, n) {
    "use strict";
            ...
            return i(t, e), l(t, [{
                ...
                value: function() {
                    ...
                    var n = _.isEmpty(powerformData.submissions_ip_retain_number) || "0" === powerformData.submissions_ip_retain_number,
                        r = (0, p.translate)("für immer");
                    return n || (r = powerformData.submissions_ip_retain_number + " " + powerformData.submissions_ip_retain_unit), c.default.createElement("div", { className: "sui-box-settings-row" }, c.default.createElement("div", { className: "sui-box-settings-col-1" }, c.default.createElement("span", { className: "sui-settings-label" }, (0, p.translate)("Datenschutz")), c.default.createElement("span", { className: "sui-description" }, (0, p.translate)("Wähle aus, wie Du mit dem Datenspeicher dieser Umfrage umgehen möchtest. Standardmäßig verwenden wir die Konfiguration, die Du in Deinen {{link}} globalen Datenschutzeinstellungen{{/link}} festgelegt hast.", { components: { link: c.default.createElement("a", { href: powerformData.settingsUrl + "&section=submissions", target: "_blank" }) } }))), c.default.createElement("div", { className: "sui-box-settings-col-2" }, c.default.createElement("div", { className: "sui-form-field" }, c.default.createElement("label", { className: "sui-settings-label" }, (0, p.translate)("Einsendungen")), c.default.createElement("span", { className: "sui-description", style: { marginBottom: "10px" } }, (0, p.translate)("Wie lange möchtest Du die Beiträge dieser Umfrage aufbewahren?")), c.default.createElement("div", { style: { marginTop: "10px" } }, c.default.createElement(d.default, s({}, this.props, { default: "false", property: "enable-submissions-retention", simple: !0 }), c.default.createElement(m.default, { value: "false", label: (0, p.translate)("Verwende Standard") }, c.default.createElement("div", { className: "sui-notice" }, c.default.createElement("p", null, (0, p.translate)("Dein Standardeinstellungswert ist, die Übermittlungen %s beizubehalten.", { args: [r] })))), c.default.createElement(m.default, s({}, this.props, { value: "true", label: (0, p.translate)("Benutzerdefiniert"), boxClass: "sui-tab-boxed" }), c.default.createElement("div", { className: "sui-row", style: { marginBottom: "10px" } }, c.default.createElement(b.default, { cols: "6" }, c.default.createElement(g.default, s({}, this.props, { type: "number", defaultValue: "0", property: "submissions-retention-number", placeholder: "10" }))), c.default.createElement(b.default, { cols: "6" }, c.default.createElement(E.default, s({}, this.props, { defaultValue: "days", property: "submissions-retention-unit" }), c.default.createElement("option", { value: "days" }, (0, p.translate)("Tag(e)")), c.default.createElement("option", { value: "weeks" }, (0, p.translate)("Woche(n)")), c.default.createElement("option", { value: "months" }, (0, p.translate)("Monat(e)")), c.default.createElement("option", { value: "years" }, (0, p.translate)("Jahr(e)"))))), c.default.createElement("span", { className: "sui-description" }, (0, p.translate)("Lasse das Feld leer, um Einsendungen für immer beizubehalten.")))))), c.default.createElement("div", { className: "sui-form-field" }, c.default.createElement("label", { className: "sui-settings-label" }, (0, p.translate)("IP-Aufbewahrung")), c.default.createElement("span", { className: "sui-description" }, (0, p.translate)("Wähle aus, wie lange die IP-Adresse beibehalten werden soll, bevor eine Übermittlung anonymisiert wird. Beachte, dass die IP-Adresse zum Überprüfen mehrerer Stimmen desselben Benutzers verwendet wird.")), c.default.createElement("div", { style: { marginTop: "10px" } }, c.default.createElement(d.default, s({}, this.props, { default: "false", property: "enable-ip-address-retention", simple: !0 }), c.default.createElement(m.default, s({}, this.props, { value: "false", label: (0, p.translate)("Verwende Standard") }), c.default.createElement("div", { className: "sui-notice" }, c.default.createElement("p", null, (0, p.translate)("Deine Standardeinstellung behält die IPs %s bei.", { args: [t] })))), c.default.createElement(m.default, s({}, this.props, { value: "true", label: (0, p.translate)("Benutzerdefiniert"), boxClass: "sui-tab-boxed" }), c.default.createElement("div", { className: "sui-row", style: { marginBottom: "10px" } }, c.default.createElement(b.default, { cols: "6" }, c.default.createElement(g.default, s({}, this.props, { type: "number", defaultValue: "0", property: "ip-address-retention-number", placeholder: "10" }))), c.default.createElement(b.default, { cols: "6" }, c.default.createElement(E.default, s({}, this.props, { defaultValue: "days", property: "ip-address-retention-unit" }), c.default.createElement("option", { value: "days" }, (0, p.translate)("Tag(e)")), c.default.createElement("option", { value: "weeks" }, (0, p.translate)("Woche(n)")), c.default.createElement("option", { value: "months" }, (0, p.translate)("Monat(e)")), c.default.createElement("option", { value: "years" }, (0, p.translate)("Jahr(e)"))))), c.default.createElement("span", { className: "sui-description" }, (0, p.translate)("Lasse das Feld leer, damit IPs für immer erhalten bleiben."))))))))
                }
            }]), t
        }(u.Component);
    t.default = O
