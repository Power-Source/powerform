        ...
        function init() {
            input.each(function() {
                $(this).on('click', function() {
                    ...
                    var radioOptions = radioField.find('.powerform-radio'); // Remove checked property (use prop instead of removeAttr for jQuery 3.x)

                    radioOptions.find('input').prop('checked', false); // Remove checked class

                    radioOptions.removeClass('powerform-is_checked'); // Assign checked property (use prop instead of attr for jQuery 3.x)

                    radioInput.prop('checked', true); // Assign checked class
