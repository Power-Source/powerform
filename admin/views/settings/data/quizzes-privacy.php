...
<div class="sui-box-settings-row">
	...
	<div class="sui-box-settings-col-1">
		<span class="sui-settings-label"><?php esc_html_e( 'Tests Datenschutz', Powerform::DOMAIN ); ?></span>
		<span class="sui-description"><?php esc_html_e( 'Wählen Sie, wie Sie mit den Test-Einsendungen umgehen möchten.', Powerform::DOMAIN ); ?></span>
	</div>

	<div class="sui-box-settings-col-2">

		<span class="sui-settings-label"><?php esc_html_e( 'Aufbewahrung der Einsendungen', Powerform::DOMAIN ); ?></span>
		<span class="sui-description"><?php esc_html_e( 'Wie lange möchten Sie die Test-Einsendungen aufbewahren?', Powerform::DOMAIN ); ?></span>
